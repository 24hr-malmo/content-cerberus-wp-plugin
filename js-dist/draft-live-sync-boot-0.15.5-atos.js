...
`;
  ...
  const updatePublicationApproval = async (status = '', options) => {
...
`;
    ...
    return [createComponent(Show, {
        ...
        return [createComponent(Show, {
          ...
          get children() {
            return createComponent(Button, {
              ...
              get children() {
                return contentStatus.changesNotSavedToDraft ? 'Save draft before publish request' : 'Request approval to publish';
              }
      ...
      get children() {
        return [createComponent(Show, {
          ...
          get children() {
            return createComponent(AdminPublicationControls, {});
          }
  ...
  const PublishingUpdateControls = () => {
    return [createComponent(Show, {
      ...
      get children() {
        return ["hejhejehj", createComponent(Show, {
          get when() {
            return !contentStatus.options.userHasPublicationRights;
          },
          ...
          get children() {
            return [createComponent(Show, {
              ...
              get children() {
                return [createComponent(Show, {
                  get when() {
                    return !options.metaMenu && options.requireApproval;
                  },

                  get children() {
                    return createComponent(PublicationApprovalStatus, {});
                  }
                  ...
                  get children() {
                    return [memo(() => publishingControls()), createComponent(Button, {
                      ...
                      get children() {
                        return createComponent(PublicationWarning, {});
                      }
...
`;
  ...
  const _tmpl$$7 = template(`<span>, requested by <em></em></span>`),
        _tmpl$2$1 = template(`<span> - rejected by <!> </span>`),
        _tmpl$3$1 = template(`<em></em>`);
...
`;
        ...
        return [createComponent(StyledType$1, {
          ...
          get children() {
            return [createComponent(StyledTitle$2, {
              get href() {
                return props.item.editorUrl;
              },

              target: "_blank",

              get children() {
                return props.item.post_title;
              }
              ...
              insert(_el$3, () => props.item.from_user_name);
              ...
              get children() {
                ...
                insert(_el$4, () => props.item.rejectedBy, _el$7);
                ...
                return createComponent(StyledRejectionPanel, {
                  get children() {
                    return [createComponent(StyledRejectionHeading, {
                      ...
                      insert(_el$8, () => props.item.rejectionReason);
  ...
  const _tmpl$$8 = template(`<span></span>`),
    ...
    return (() => {
      ...
      insert(_el$, (() => {
        ...
        return createComponent(Show, {
          ...
          get children() {
            return [memo(() => createStatusList({
              title: 'Pending',
              siteRequests: pending()
            })), memo(() => createStatusList({
              title: 'Approved',
...
//# sourceMappingURL=draft-live-sync-boot-0.15.5-atos.js.map
