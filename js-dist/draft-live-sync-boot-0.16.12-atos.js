...
`,[Dt,Et]=Te({options:{},setChecking:()=>!0,syncStatus:{},publish:()=>null,changesNotSavedToDraft:!1,showRejectionControls:!1,rejectionReason:"",approvalStatus:"",errorMessage:"",approvedBy:""}),Rt=e=>{Et({approvalStatus:e})},$t=()=>{Et((e=>({showRejectionControls:!e.showRejectionControls})))},Lt=async(e="")=>{Dt.setChecking(!0);const t=await(async e=>{try{var t;return await Ge(`${Dt.options.api}/upsert-publication-request.php`,{permalink:Dt.options.permalink,status:e,editorUrl:null===(t=window)||void 0===t?void 0:t.location.href,approvedBy:"approved"===e?Dt.options.userName:"",rejectedBy:"rejected"===e?Dt.options.userName:"",requestedBy:"pending"===e?Dt.options.userName:Dt.requestedBy,rejectionReason:Dt.rejectionReason}),{}}catch(e){return console.log("Error upserting publication request",e),{err:e}}})(e);t.err?(Et({errorMessage:"Error changing status to "+e}),console.log("Err upserting request",t.err)):Rt(e),Dt.setChecking(!1),"approved"!==e&&"rejected"!==e||zt()},zt=async()=>{const{postTitle:e,rejectionReason:t,approvalStatus:n,editorEmail:r}=Dt,{userName:o,siteTitle:i}=Dt.options;try{var l;await Ge(`${Dt.options.api}/send-publication-approval-email.php`,{data:{useCustomMailSystem:Dt.options.useCustomSmtp,postTitle:e,rejectionReason:t,approvalStatus:n,admin:o,editorEmail:r,siteTitle:i,postUrl:null===(l=window)||void 0===l?void 0:l.location.href}})}catch(e){console.log("Error sending email")}},Bt=async()=>{Dt.setChecking(!0);const e=await(async()=>{console.log("Deleting pub request for "+Dt.options.permalink+": ",Dt);try{var e,t;const o=await Ge(`${Dt.options.api}/delete-publication-request.php`,{postId:Dt.options.postId});var n,r;return null!=o&&null!==(e=o.data)&&void 0!==e&&null!==(t=e.deleteResource)&&void 0!==t&&t.success||console.log("Unable to delete publication request because: ",null==o||null===(n=o.errors)||void 0===n||null===(r=n[0])||void 0===r?void 0:r.message),{}}catch(e){return console.log("Error deleting request",e),{err:e}}})();e.err?(Et({errorMessage:"Something went wrong withdrawing publication request"}),console.log("Err deleting request",e.err)):Rt(""),Dt.setChecking(!1)},Ot=le("<em></em>"),Ht=Qe("div")`
    padding: 0.25rem;
    background: #fefbe6;
`,It=()=>U(V,{get children(){return[U(W,{get when(){return"pending"===Dt.approvalStatus},get children(){return U(Tt,{get horizontal(){return Dt.options.metaMenu},children:"Pending approval"})}}),U(W,{get when(){return"approved"===Dt.approvalStatus},get children(){return U(Tt,{get horizontal(){return Dt.options.metaMenu},get children(){return["Publication approved ",ne((()=>Dt.approvedBy?" by "+Dt.approvedBy:""))]}})}}),U(W,{get when(){return"rejected"===Dt.approvalStatus},get children(){return[U(Tt,{get horizontal(){return Dt.options.metaMenu},get children(){return["Publication rejected ",ne((()=>Dt.rejectedBy?" by "+Dt.rejectedBy:""))]}}),U(Y,{get when(){return Dt.rejectionReason},get children(){return U(Ht,{get children(){const e=Ot.cloneNode(!0);return ge(e,(()=>Dt.rejectionReason)),e}})}})]}})]}}),Ut=()=>U(ht,{get leftMargin(){return Dt.options.metaMenu},get loading(){return Dt.publishing},onClick:e=>Dt.publish(e),get disabled(){return Dt.changesNotSavedToDraft},get children(){var e,t,n;return Dt.changesNotSavedToDraft?null!==(e=Dt.syncStatus.live)&&void 0!==e&&e.exists?"Save draft before updating on live":"Save draft before publishing to live":null!==(t=Dt.syncStatus.live)&&void 0!==t&&t.exists?null!==(n=Dt.syncStatus.live)&&void 0!==n&&n.synced?"Updated on live site":"Update on live site":"Publish to live site"}}),Ft=le('<div><h4>Rejection reason</h4><textarea rows="4" placeholder="Message to the editor" maxlength="200"></textarea><div></div></div>'),Kt=()=>[U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>Lt("approved"),get disabled(){return Dt.showRejectionControls},children:"Approve "}),U(Y,{get when(){return!Dt.showRejectionControls},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>{$t()},get disabled(){return Dt.showRejectionControls},children:"Reject"})}}),U(Y,{get when(){return Dt.showRejectionControls},get children(){const e=Ft.cloneNode(!0),t=e.firstChild,n=t.nextSibling,r=n.nextSibling;return e.style.setProperty("margin-block","1.5rem"),t.style.setProperty("margin-bottom",0),n.addEventListener("change",(e=>{var t;t=e.target.value,Et({rejectionReason:t})})),n.style.setProperty("width","100%"),n.style.setProperty("margin-top","0.5rem"),r.style.setProperty("display","flex"),ge(r,U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>$t(),disabled:!1,style:{"margin-top":0,"margin-right":"0.2rem"},children:"Cancel"}),null),ge(r,U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>Lt("rejected"),disabled:!1,style:{"margin-top":0},children:"Send rejection"}),null),e}}),U(Y,{get when(){return!Dt.showRejectionControls},get children(){return U(Ut,{})}})],Jt=le("<div><h5>Dev mode</h5></div>"),Qt=()=>(()=>{const e=Jt.cloneNode(!0);return e.firstChild,e.style.setProperty("background","lightgray"),e.style.setProperty("padding","0.5rem"),ge(e,U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>Lt("approved"),disabled:!1,children:"Approve"}),null),ge(e,U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>Lt("rejected"),disabled:!1,children:"Reject"}),null),ge(e,U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>Lt("pending"),get disabled(){return Dt.changesNotSavedToDraft},children:"Set to pending"}),null),e})(),Yt=()=>[U(Y,{get when(){return""===Dt.approvalStatus},get children(){return[U(Y,{get when(){return Dt.options.userHasPublicationRights},get children(){return U(Ut,{})}}),U(Y,{get when(){return!Dt.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>Lt("pending"),get disabled(){return Dt.changesNotSavedToDraft},get children(){return Dt.changesNotSavedToDraft?"Save draft before publishing request":"Request approval to publish"}})}})]}}),U(Y,{when:false,get children(){return U(Qt,{})}}),U(Y,{get when(){return"pending"===Dt.approvalStatus},get children(){return[U(Y,{get when(){return Dt.options.userHasPublicationRights},get children(){return U(Kt,{})}}),U(Y,{get when(){return!Dt.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>Bt(),disabled:!1,children:"Withdraw publication request"})}})]}}),U(Y,{get when(){return"approved"===Dt.approvalStatus},get children(){return[U(Y,{get when(){return Dt.options.userHasPublicationRights},get children(){return U(Ut,{})}}),U(Y,{get when(){return!Dt.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},get loading(){return Dt.publishing},onClick:e=>Dt.publish(e),get disabled(){return Dt.changesNotSavedToDraft},get children(){return Dt.changesNotSavedToDraft?"Discard unapproved changes to publish":"Publish to live site"}})}})]}}),U(Y,{get when(){return"rejected"===Dt.approvalStatus},get children(){return U(Y,{get when(){return Dt.options.userHasPublicationRights},get children(){return U(Ut,{})}})}})],Vt=()=>U(Y,{get when(){return"pending"===Dt.approvalStatus&&Dt.changesNotSavedToDraft},get children(){return U(Nt,{children:"Saving a new draft will automatically withdraw the pending publication approval"})}}),Wt=()=>[U(Y,{get when(){return""===Dt.approvalStatus},get children(){return[U(Y,{get when(){return Dt.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},get loading(){return Dt.publishing},onClick:e=>Dt.publish(e),get disabled(){var e;return(null===(e=Dt.syncStatus.live)||void 0===e?void 0:e.synced)||Dt.changesNotSavedToDraft},get children(){var e;return Dt.changesNotSavedToDraft?"Save draft before updating on live":null!==(e=Dt.syncStatus.live)&&void 0!==e&&e.synced?"Updated on live site":"Update on live site"}})}}),U(Y,{get when(){return!Dt.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},get loading(){return Dt.publishing},onClick:e=>Lt("pending"),get disabled(){var e;return(null===(e=Dt.syncStatus.live)||void 0===e?void 0:e.synced)||Dt.changesNotSavedToDraft},get children(){var e;return Dt.changesNotSavedToDraft?"Save draft before requesting publication approval":null!==(e=Dt.syncStatus.live)&&void 0!==e&&e.synced?"Updated on live site":"Request approval to publish"}})}})]}}),U(Y,{get when(){return"pending"===Dt.approvalStatus},get children(){return[U(Y,{get when(){return Dt.options.userHasPublicationRights},get children(){return U(Kt,{})}}),U(Y,{get when(){return!Dt.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>Bt(),disabled:!1,children:"Withdraw publication request"})}})]}}),U(Y,{get when(){return"approved"===Dt.approvalStatus},get children(){return[U(Y,{get when(){return Dt.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},get loading(){return Dt.publishing},onClick:e=>Dt.publish(e),get disabled(){var e;return(null===(e=Dt.syncStatus.live)||void 0===e?void 0:e.synced)||Dt.changesNotSavedToDraft},get children(){var e;return Dt.changesNotSavedToDraft?"Save draft before publishing to live":null!==(e=Dt.syncStatus.live)&&void 0!==e&&e.synced?"Updated on live site":"Update on live site"}})}}),U(Y,{get when(){return!Dt.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},get loading(){return Dt.publishing},onClick:e=>Dt.publish(e),get disabled(){var e;return(null===(e=Dt.syncStatus.live)||void 0===e?void 0:e.synced)||Dt.changesNotSavedToDraft},get children(){var e;return Dt.changesNotSavedToDraft?"Save to draft or discard unapproved changes to publish":null!==(e=Dt.syncStatus.live)&&void 0!==e&&e.synced?"Updated on live site":"Update on live site"}})}})]}}),U(Y,{get when(){return"rejected"===Dt.approvalStatus},get children(){return U(Y,{get when(){return!Dt.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Dt.options.metaMenu},onClick:e=>null,disabled:!0,get children(){return Dt.changesNotSavedToDraft?"Save draft before requesting publication approval":"Make changes before requesting approval to publish"}})}})}})],Xt=({options:e})=>{const[t,n]=Te({}),[r,o]=g(!0),[i,l]=g(!1),[s,a]=g(!1),[c,d]=g(!1),[u,p]=g(!1),[h,v]=g(!1),[m,b]=g(!1),[w,x]=g(!1),[k,S]=g(!1);let C,j,M={permalink:e.permalink};const q=!e.metaMenu&&!e.optionsMeta;y((()=>{q&&e.requireApproval&&Et({options:e,setChecking:o,syncStatus:t,publish:e=>$(e)})})),f((()=>{var t,n;e.metaMenu?(j=document.querySelector("#save_menu_footer"),N()):null!==(t=wp)&&void 0!==t&&null!==(n=t.data)&&void 0!==n&&n.select&&(C=wp.data.select("core/editor"),wp.domReady(A))})),f((()=>{wp&&wp.hooks&&wp.hooks.addAction&&(D(),wp.hooks.addAction("dls.post-saved","dls",(()=>{var e,n,r;if(null!=t&&null!==(e=t.draft)&&void 0!==e&&e.exists||null===(n=C)||void 0===n||!n.isPublishingPost())null!=t&&null!==(r=t.draft)&&void 0!==r&&r.exists&&(A(),D());else{let e=0;const t=()=>{const e=C.getPermalink(),t=/http(s|):\/\/(.*?)(\/[\w\/-]*)\//gm.exec(e);return t?t[3]:""},n=()=>{if("auto-draft"!==C.getCurrentPost().status)return M={permalink:t()},p(!1),void D();e++<=50&&setTimeout(n,100)};n()}})))})),f((()=>{let e;document.addEventListener("cerberusListenerEvent",(t=>{var n;null!=t&&null!==(n=t.detail)&&void 0!==n&&n.hasChange&&(e||(e=document.querySelector(".editor-post-publish-button"),e.addEventListener("click",(()=>{b(!1),e.setAttribute("disabled",!0),window.onbeforeunload=null}))),e&&(b(!0),e.removeAttribute("disabled"),window.onbeforeunload=()=>!0))}))}));const A=()=>{let e;const t=wp.data.subscribe(_.debounce((()=>{e||(e=document.querySelector(".editor-post-publish-button"));const n=C.isEditedPostDirty(),r=C.hasNonPostEntityChanges(),o=m();r||n||o?(p(!0),e&&e.addEventListener("click",P),e&&e.removeAttribute("disabled"),t()):(p(!1),e&&e.removeEventListener("click",P),e&&e.setAttribute("disabled",!0))}),100))},P=()=>{""!==Dt.approvalStatus&&q&&e.requireApproval&&Dt.options.requireApproval&&Bt()},N=()=>{let e,t=!1;j.setAttribute("disabled",!0);let n=()=>{t||clearInterval(e)},r=()=>{t||(e=o())};const o=()=>setInterval((()=>{var o,i;null!==(o=window)&&void 0!==o&&null!==(i=o.wpNavMenu)&&void 0!==i&&i.menusChanged&&(t=!0,T(),clearInterval(e),window.removeEventListener("blur",n),window.removeEventListener("focus",r))}),500);e=o(),window.addEventListener("blur",n),window.addEventListener("focus",r)},T=()=>{j.removeAttribute("disabled"),v(!0)},D=async(r=!0)=>{r&&(o(!0),await new Promise((e=>setTimeout(e,1e3))));try{var i;const r=await Xe("check_sync",{...M,api_path:M.permalink});if(null==r||null===(i=r.data)||void 0===i||!i.resourceStatus)throw M;n({draft:r.data.resourceStatus.find((e=>"draft"===e.target&&"__original"===e.comparedTo)),live:r.data.resourceStatus.find((e=>"live"===e.target&&"draft"===e.comparedTo)),state:"loaded"}),console.log("status: ",t),S(!1),q&&e.requireApproval&&(async()=>{try{var e;const t=await Ge(`${Dt.options.api}/get-publication-request.php`,{postId:Dt.options.postId});if(null!==(e=t.data.resource)&&void 0!==e&&e.content){const e=t.data.resource.content;Et({approvalStatus:e.status,approvedBy:e.approvedBy,rejectedBy:e.rejectedBy,rejectionReason:e.rejectionReason||"",requestedBy:e.requestedBy,editorEmail:e.from_user_email,postTitle:e.post_title,siteTitle:e.from_site_name}),console.log(`Publication request for ${Dt.options.permalink}: `,Dt)}else console.log("No publication request found for:",Dt.options.permalink),Rt("")}catch(e){console.log("Error fetching publication request",e)}})(),e.metaMenu&&E()}catch(e){console.log("--- meta-box --- Can't find any data with check-sync of payload: ",e),S(!0),o(!1),n({state:"error"})}o(!1)},E=async()=>{var e;const n=document.querySelectorAll(".menu-theme-locations > .menu-settings-input"),r=document.querySelector(".menu-settings-group.menu-theme-locations"),o=document.createElement("i");o.classList.add("changes-disabled-message");const i=null===(e=t.draft)||void 0===e?void 0:e.exists,l=t.live&&t.live.exists;!i||l?(r.style.pointerEvents="none",r.style.cursor="not-allowed",r.style.opacity=.5):(r.style.pointerEvents="auto",r.style.cursor="default",r.style.opacity=1);const s=document.querySelector(".changes-disabled-message");if(l){const e="Menu must be unpublished before toggling location";s?s.innerHTML=e:(o.innerHTML=e,r.prepend(o))}else{const e="Menu must be created before toggling location";i?s&&s.parentNode.removeChild(s):s?s.innerHTML=e:(o.innerHTML=e,r.prepend(o))}let a=!1,c=!1;for(let e of n){const t=e.querySelector("input");t.addEventListener("change",(()=>{d(!0),T()}));e.querySelector(".theme-location-set")&&(t.setAttribute("disabled",!0),e.style.pointerEvents="none",e.style.opacity=.5,c=!0),t.getAttribute("checked")&&(a=!0)}if(c&&!l&&i){const e=document.querySelector(".changes-disabled-message"),t="Some locations cannot be set because they are already set";e?e.innerHTML=t:(o.innerHTML=t,r.prepend(o))}if(location.search.includes("menu=0"))return;x(!0);const u=document.querySelector(".submitdelete.deletion.menu-delete");let p=document.querySelector(".delete-link-replacement");a||l?(u.style.display="none",p?p.style.display="inline":(p=document.createElement("span"),p.classList.add("delete-link-replacement"),p.innerHTML="To delete a menu it must be unpublished (and unregisterered from all display locations)",p.style.color="#a7aaad",p.style.fontSize="12px"),u.parentNode.prepend(p)):(u.style.display="inline",p&&(p.style.display="none"))},R=(e={})=>{if(document){const t=new CustomEvent("cerberusChangeEvent",{detail:e});document.dispatchEvent(t)}},$=async t=>{t.preventDefault(),t.stopPropagation(),l(!0);(await Xe("publish_to_live",M)).data?D(!1):n({state:"error"}),await new Promise((e=>setTimeout(e,1e3))),l(!1),q&&e.requireApproval&&""!==Dt.approvalStatus&&Bt(),R({action:"publish_to_live_done"})},L=async e=>{e.preventDefault(),e.stopPropagation(),a(!0);(await Xe("unpublish_from_live",M)).data?D(!1):n({state:"error"}),await new Promise((e=>setTimeout(e,1e3))),a(!1),R({action:"unpublish_from_live_done"})};f((()=>{q&&Et({changesNotSavedToDraft:z()})})),f((()=>{q&&Et({publishing:i()})})),f((()=>{q&&Et({publishing:i()})}));const z=()=>u()||h()||m();return U(At,{get horizontal(){return e.metaMenu},get box(){return e.optionsMeta},get children(){return[U(Y,{get when(){return r()},get children(){return U(_t,{get horizontal(){return e.metaMenu},get children(){return[U(ut,{get size(){return e.metaMenu?"small":"large"}}),U(Tt,{children:"Checking content in draft and live"})]}})}}),U(Y,{get when(){return!r()},get children(){return[U(Y,{get when(){return k()},get children(){return U(_t,{get horizontal(){return e.metaMenu},get children(){return U(Tt,{children:"Content must be saved before publishing"})}})}}),U(Y,{get when(){var e;return!c()&&(null===(e=t.draft)||void 0===e?void 0:e.exists)},get children(){return[U(Y,{get when(){return q&&e.requireApproval},get children(){return U(It,{})}}),U(Y,{get when(){return!e.requireApproval},get children(){return U(Tt,{get horizontal(){return e.metaMenu},children:"Publish content"})}}),U(Y,{get when(){var e;return!(null!==(e=t.live)&&void 0!==e&&e.exists)},get children(){return[ne((()=>q&&e.requireApproval?U(Yt,{}):U(ht,{get leftMargin(){return e.metaMenu},get loading(){return i()},onClick:e=>$(e),get disabled(){return z()},get children(){return z()?"Save draft before publishing to live":"Publish to live site"}}))),U(ht,{get leftMargin(){return e.metaMenu},disabled:!0,children:"Content not published"}),U(Y,{when:q,get children(){return U(Vt,{})}})]}}),U(Y,{get when(){var e;return null===(e=t.live)||void 0===e?void 0:e.exists},get children(){return[ne((()=>q&&!e.optionsMeta&&e.requireApproval?U(Wt,{}):U(ht,{get leftMargin(){return e.metaMenu},get loading(){return i()},onClick:e=>$(e),get disabled(){var e;return(null===(e=t.live)||void 0===e?void 0:e.synced)||z()},get children(){var e;return z()?"Save draft before updating on live":null!==(e=t.live)&&void 0!==e&&e.synced?"Updated on live site":"Update on live site"}}))),U(ht,{get leftMargin(){return e.metaMenu},get loading(){return s()},onClick:e=>L(e),get disabled(){return m()},children:"Unpublish"}),U(Y,{when:q,get children(){return U(Vt,{})}})]}})]}}),U(Y,{get when(){return e.metaMenu},get children(){return U(_t,{get horizontal(){return e.metaMenu},get children(){return[U(Y,{get when(){return!w()},get children(){return U(Tt,{children:"Enter a 'Menu Name' above to create a new menu"})}}),(()=>{const e=ne((()=>{var e;return!(c()||null!==(e=t.draft)&&void 0!==e&&e.exists)}),!0);return U(Y,{get when(){return e()&&w()},get children(){return U(Tt,{children:"Save menu with menu items in order to publish"})}})})(),U(Y,{get when(){return c()},get children(){return U(Tt,{children:"Save the changes before publishing"})}})]}})}})]}}),U(Y,{get when(){return e.enableTestContent},get children(){return U(ht,{get leftMargin(){return e.metaMenu},get loading(){return s()},onClick:e=>L(e),get disabled(){var e;return!(null!==(e=t.test)&&void 0!==e&&e.synced)},get children(){return t.test&&t.test.synced?"Unpublish from test target":"Publish to test target"}})}}),U(Y,{get when(){return Dt.errorMessage},get children(){return U(Pt,{get children(){return Dt.errorMessage}})}})]}})},Gt=Qe("input")`
`,Zt=Qe("div")`
    display: flex;
    flex-direction: column;
    width: 100%;
