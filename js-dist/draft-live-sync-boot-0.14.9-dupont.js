...
`,Et=Re("label")`
    ...
    font-size: 10px;
    height: 18px;
`,Lt=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return F(Tt,{get children(){return[F(Et,{children:t}),F(Pt,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},$t=Re("select")`
...
`,Dt=Re("label")`
    ...
    font-size: 10px;
    height: 18px;
`,Ot=re("<option></option>"),zt=({options:e=[],placeholder:t="",label:n=" ",value:r,onChange:o=(()=>{})})=>{const i=e=>{console.log(e),o(e.target.value)};return F(Nt,{get children(){return[F(Dt,{children:n}),F($t,{get value(){return r()},placeholder:t,onChange:i,get children(){return F(J,{each:e,children:e=>(()=>{const t=Ot.cloneNode(!0);return de(t,(()=>e.label)),f((n=>{const o=e.value,i=e.value===r();return o!==n._v$&&(t.value=n._v$=o),i!==n._v$2&&(t.selected=n._v$2=i),n}),{_v$:void 0,_v$2:void 0}),t})()})}})]}})},qt={open:Fe`
    0% {
        max-height: 0;
    }
    100% {
