...
`,$t=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,Lt=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return F(Et,{get children(){return[F($t,{children:t}),F(Nt,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},Dt=Ue("select")`
...
`,Gt=Ue("div")`
    margin-left: 2rem;
`,Wt=re("<thead><tr><th>Domain</th><th>Distribution ID</th><th>Target</th><th>SiteId</th><th>Delete</th><th>Do not index</th><th>Save</th></tr></thead>"),en=re("<tbody></tbody>"),tn=re('<input type="checkbox">'),nn=re("<tr><td></td><td></td><td></td><td></td><td></td></tr>"),rn=[{value:"draft",label:"Draft"},{value:"live",label:"Live"},{value:"test",label:"Test"}];const on=({options:e})=>{const[t,n]=Te({list:[]}),[r,o]=h(""),[i,l]=h(""),[s,a]=h("draft"),[c,d]=h("init"),[u,p]=h(""),[m,b]=h(!1),y=async()=>{const t=await Ve(`${e.api}/get-domain-settings.php`);t.sort(((e,t)=>e.key.localeCompare(t.key))),n("list",t)},v=async(t=function(e){for(var t="",n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",r=n.length,o=0;o<e;o++)t+=n.charAt(Math.floor(Math.random()*r));return t}(20))=>{try{const n=function(e){const t=e.match(/^(?:https?:\/\/)?(?:www\.)?([^\/\n]+)/);if(t){const e=t[1];return/^[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}$/.test(e)?e:null}return null}(r());if(null===n)return void p("Invalid domain. Please enter a valid domain without http(s):// or path.");if(p(""),m())return;b(!0),await Ve(`${e.api}/upsert-domain-setting.php`,{domain:n,target:s(),id:t,cloudfrontDistributionId:i()}),await y(),a("draft"),o(""),l(""),b(!1),d("close")}catch(e){console.log("ee",e),"domain-already-exists"===e.error?p("Domain already exists"):p("Something caused an error"),b(!1)}},x=(e,t)=>{"domain"===e&&o(t),"target"===e&&a(t),"cloudfrontDistributionId"===e&&l(t)};g((()=>{y()}));return F(Ht,{get children(){return[F(nt,{children:"Domain Settings"}),F(tt,{children:"This is the list of domains and targets that will be used for this site. You can add as many as you need but the domains need to be pointed to the server to make it work."}),F(Ft,{get children(){return F(ut,{onClick:()=>d("open"),children:"Add new domain and target"})}}),F(Rt,{get state(){return c()},get children(){return F(Ut,{get children(){return[F(ot,{children:"Add new domain and target"}),F(Kt,{get children(){return[F(Lt,{placeholder:"domain",label:"Domain:",value:r,onChange:e=>x("domain",e)}),F(Lt,{placeholder:"distribution id",label:"Cloudfront Distribution ID:",value:i,onChange:e=>x("cloudfrontDistributionId",e)}),F(qt,{options:rn,value:s,onChange:e=>x("target",e)})]}}),F(Q,{when:u,get children(){return F(Qt,{children:u})}}),F(Jt,{get children(){return[F(ut,{onClick:()=>d("close"),children:"Cancel"}),F(ut,{get loading(){return m()},leftMargin:!0,get disabled(){return!r()||!s()},onClick:()=>v(),children:"Save"})]}})]}})}}),F(Xt,{get children(){return[Wt.cloneNode(!0),(()=>{const r=en.cloneNode(!0);return de(r,F(J,{get each(){return t.list},children:(r,o)=>(()=>{const i=nn.cloneNode(!0),l=i.firstChild,s=l.nextSibling,a=s.nextSibling,c=a.nextSibling,d=c.nextSibling;return de(l,(()=>r.content.domain)),de(s,(()=>r.content.cloudfrontDistributionId)),de(a,(()=>r.content.target)),de(c,(()=>r.content.siteId)),de(i,F(Yt,{get children(){return F(Zt,{onClick:()=>(async t=>{try{await Ve(`${e.api}/delete-domain-setting.php`,{id:t}),await y()}catch(e){console.log(e)}})(r.externalId),children:"delete"})}}),d),de(d,F(Gt,{get children(){const e=tn.cloneNode(!0);return e.addEventListener("change",(e=>{const t=e.target.checked;((e,t)=>{n("list",e,"content","doNotIndex",t)})(o(),t)})),f((()=>e.checked=r.content.doNotIndex)),e}})),de(i,F(Yt,{get children(){return F(Vt,{onClick:()=>{(async(n,r)=>{const o=t.list.find((e=>e.externalId===n));o&&(await Ve(`${e.api}/upsert-domain-setting.php`,{domain:o.content.domain,target:o.content.target,id:o.externalId,cloudfrontDistributionId:o.content.cloudfrontDistributionId,doNotIndex:r.doNotIndex}),await y())})(r.externalId,r.content)},children:"save"})}}),null),i})()})),r})()]}})]}})},ln=e=>{try{return JSON.parse(document.getElementById(e).innerHTML)}catch(e){return{}}},sn=()=>{let e=document.getElementById("dls-metabox-root");if(e){const t=ln("dls-data");t.metaMenu="nav-menu"===e.getAttribute("data-type"),t.metaMenu&&(e=document.createElement("div"),e&&document.querySelector("#nav-menu-footer").prepend(e)),ne((()=>F(Pt,{options:t})),e)}};jQuery(document).ready((function(e){wp&&wp.data&&wp.data.dispatch&&wp.data.dispatch("core/editor").disablePublishSidebar(),(()=>{if(wp.data){let e=!1,t=!1;wp.data.subscribe((()=>{const n=wp.data.select("core/editor").isSavingPost(),r=wp.data.select("core/editor").isSavingNonPostEntityChanges&&wp.data.select("core/editor").isSavingNonPostEntityChanges();e!==n?(e=n,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved")):t!==r&&(t=r,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved"))}))}})();let t={};try{t=e("#dls-hooks").length>0?JSON.parse(e("#dls-hooks").html()):{hook:""}}catch(e){}console.log("Current hook",t&&t.hook),"post.php"===t.hook||"post-new.php"===t.hook||"nav-menus.php"===t.hook?sn():t.hook.includes("toplevel_page_draft-live-sync")?(()=>{const e=ln("dls-data");ne((()=>F(Ne,{values:e,get children(){return F(_t,{})}})),document.getElementById("dls-root"))})():t.hook.includes("toplevel_page_cerberus-domain-settings")?(()=>{const e=document.getElementById("dls-domain-settings-root"),t=ln("dls-data");ne((()=>F(on,{options:t})),e)})():t.hook.includes(".php")||sn()}))}();
//# sourceMappingURL=draft-live-sync-boot-0.14.21-dupont.js.map
