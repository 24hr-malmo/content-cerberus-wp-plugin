...
`,st=Je("h3")`
    ...
    margin-bottom: .5rem;
    margin-top: 0px;
`,at=e=>U(tt,{get children(){return[U(nt,{get children(){return[U(lt,{get children(){return e.title}}),U(ot,{get children(){return e.description}})]}}),U(rt,{get children(){return e.actions}})]}});Je("svg")`
    margin: auto; 
    background: white;
    display: block; 
...
`,gt=Je("div")`
    position: absolute;
    right: 7px;
`,ht=e=>U(pt,Y(e,{get children(){return[ne((()=>e.children)),U(Q,{get when(){return e.loading},get children(){return U(gt,{get children(){return U(ut,{size:"small",get inverted(){return!e.disabled}})}})}})]}})),ft=Je("div")`
    display: flex;
    margin-bottom: 2px;
`,vt=Je("div")`
...
`,wt=le('<svg height="10" width="10"><circle cx="5" cy="5" r="5" stroke-width="0"></circle></svg>'),xt=({showCheckButton:e,showSyncButton:t,showDraft:n,showLive:r,item:o,onClick:i,onTypeClick:l,getAllTargetsContent:s})=>{const a=(e,t)=>{let n="#bbbbbb";return"error"===t?n="#da694b":""===t?n="#bbbbbb":e&&(n=e.synced?"#99da4b":"#e9da4e"),n},d=async()=>{console.log("Item: ",o);try{const e=await s();console.log(e)}catch(e){console.log("Error logging diff: ",e)}};return U(ft,{get children(){return[U(Q,{when:n,get children(){return U(yt,{get color(){var e,t;return a(null===(e=o.status)||void 0===e?void 0:e.draft,null===(t=o.status)||void 0===t?void 0:t.state)},get children(){return wt.cloneNode(!0)}})}}),U(Q,{when:r,get children(){return U(yt,{get color(){var e,t;return a(null===(e=o.status)||void 0===e?void 0:e.live,null===(t=o.status)||void 0===t?void 0:t.state)},get children(){return wt.cloneNode(!0)}})}}),U(Q,{when:t,get children(){return U(mt,{onClick:i,children:"sync"})}}),U(Q,{when:e,get children(){return U(mt,{onClick:i,children:"check"})}}),U(Q,{when:e,get children(){return U(mt,{onClick:d,children:"log"})}}),U(vt,{onClick:l,get children(){return o.type}}),U(bt,{target:"_new",get href(){return o.permalink},get children(){return o.permalink||"/"}})]}})},kt=({type:e})=>{const[t,{apiUrl:n}]=k(Ee),[r,o]=Te({list:[]}),[i,l]=g(!1);f((async()=>{const e=(await Xe("get_all_resources")).list.map(((e,t)=>({...e,index:t})));o({list:e})}));const s=async t=>{try{(await Ge(`${n}/sync.php`,{action:"sync",permalink:t.permalink,release:e,sync_check:!1})).data?o("list",t.index,"status",{[e]:{synced:!0},state:"loaded"}):o("list",t.index,"status",{state:"error"})}catch(e){o("list",t.index,"status",{state:"error"})}},a="draft"===e?"Begin to sync to Draft":"Publish everything to Live",d="draft"===e?"Sync Draft":"Sync Live",c="draft"===e?"This is where you can make sure that wordpress and the draft content is in sync":"This is where you can make sure that Draft and Live are in sync";return U(et,{get children(){return[U(at,{title:d,description:c,get actions(){return U(ht,{get loading(){return i()},onClick:()=>(async()=>{if(i())return;let t=!1;if(("live"===e&&confirm("Do you really which to publish everything?")||"draft"===e)&&(t=!0),t){l(!0),r.list.forEach(((e,t)=>{o("list",t,"status",{state:""}),t++}));for await(let e of r.list)await s(e);l(!1)}})(),children:a})}}),U(J,{get each(){return r.list},children:t=>U(xt,{showDraft:"draft"===e,showLive:"live"===e,showSyncButton:!0,onClick:()=>(async e=>{l(!0),await s(e),l(!1)})(t),onTypeClick:()=>(async e=>{l(!0);const t=r.list.filter((t=>t.type===e));t.forEach(((e,t)=>{o("list",t,"status",{state:""}),t++}));for await(let e of t)await s(e);l(!1)})(t.type),item:t,get permalink(){return t.permalink}})})]}})},St=()=>{const[e,{apiUrl:t}]=k(Ee),[n,r]=Te({list:[]}),[o,i]=g(!1);console.log(t),f((async()=>{const e=(await Xe("get_all_resources")).list.map(((e,t)=>({...e,index:t})));r({list:e})}));const l=async e=>{try{const n=await Ge(`${t}/check-sync.php`,{permalink:e.permalink});r("list",e.index,"status",{draft:n.data.resourceStatus.find((e=>"draft"===e.target&&"__original"===e.comparedTo)),live:n.data.resourceStatus.find((e=>"live"===e.target&&"draft"===e.comparedTo)),state:"loaded"})}catch(t){r("list",e.index,"status",{state:"error"})}};return U(et,{get children(){return[U(at,{title:"Sync Check",description:"This is where you can check if all content is in sync",get actions(){return U(ht,{get loading(){return o()},onClick:()=>(async()=>{if(!o()){i(!0),n.list.forEach(((e,t)=>{r("list",t,"status",{state:""}),t++}));for await(let e of n.list)await l(e);i(!1)}})(),children:"Begin to check"})}}),U(J,{get each(){return n.list},children:e=>U(xt,{showDraft:!0,showLive:!0,showCheckButton:!0,item:e,getAllTargetsContent:()=>(async e=>await Ge(`${t}/get-all-targets-content.php`,{permalink:e}))(e.permalink),get permalink(){return e.permalink},onClick:()=>(async e=>{i(!0),await l(e),i(!1)})(e),onTypeClick:()=>(async e=>{i(!0);const t=n.list.filter((t=>t.type===e));t.forEach(((e,t)=>{r("list",t,"status",{state:""}),t++}));for await(let e of t)await l(e);i(!1)})(e.type)})})]}})},Ct=Je("p")`
    ...
    padding: 1rem 2rem;
    text-align: center;
`,Pt=()=>U(et,{get children(){return[U(at,{title:"Start",description:"This plugin lets you control and debug content through the content service."}),U(Ct,{children:"This is mainly used while developing or by admins!"})]}}),jt=Je("div")`
     color: black;
     max-width: 1200px;
     margin: 0 auto;
`;Je("div")`
`,Je("div")`
    font-size: 1rem;
    padding: 1rem 0;
`;const At=()=>{const[e]=k(Ee);return U(jt,{get children(){return[U(it,{children:"Content Dashboard"}),U(We,{}),U(Q,{get when(){return"start"===e.path},get children(){return U(Pt,{})}}),U(Q,{get when(){return"sync-check"===e.path},get children(){return U(St,{})}}),U(Q,{get when(){return"sync-draft"===e.path},get children(){return U(kt,{type:"draft"})}}),U(Q,{get when(){return"sync-live"===e.path},get children(){return U(kt,{type:"live"})}})]}})},Mt=Je("div")`
...
`,en=Je("label")`
    ...
    font-size: 10px;
    height: 18px;
`,tn=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return U(Zt,{get children(){return[U(en,{children:t}),U(Gt,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},nn=Je("select")`
...
`,bn=Je("td")`
    display: flex;
    justify-content: flex-end;
`,yn=le("<thead><tr><th>Domain</th><th>Distribution ID</th><th>Target</th><th>SiteId</th><th></th></tr></thead>"),wn=le("<tbody></tbody>"),xn=le("<tr><td></td><td></td><td></td><td></td></tr>"),kn=[{value:"draft",label:"Draft"},{value:"live",label:"Live"},{value:"test",label:"Test"}];const Sn=({options:e})=>{const[t,n]=Te({list:[]}),[r,o]=g(""),[i,l]=g(""),[s,a]=g("draft"),[d,c]=g("init"),[u,p]=g(""),[h,v]=g(!1),m=async()=>{const t=await Ge(`${e.api}/get-domain-settings.php`);n("list",t)},b=async(t=function(e){for(var t="",n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",r=n.length,o=0;o<e;o++)t+=n.charAt(Math.floor(Math.random()*r));return t}(20))=>{try{if(p(""),h())return;v(!0),await Ge(`${e.api}/upsert-domain-setting.php`,{domain:r(),target:s(),id:t,cloudfrontDistributionId:i()}),await m(),a("draft"),o(""),l(""),v(!1),c("close")}catch(e){console.log("ee",e),"domain-already-exists"===e.error?p("Domain already exists"):p("Something caused an error"),v(!1)}},y=(e,t)=>{"domain"===e&&o(t),"target"===e&&a(t),"cloudfrontDistributionId"===e&&l(t)};return f((()=>{m()})),U(dn,{get children(){return[U(it,{children:"Domain Settings"}),U(ot,{children:"This is the list of domains and targets that will be used for this site. You can add as many as you need but the domains need to be pointed to the server to make it work."}),U(cn,{get children(){return U(ht,{onClick:()=>c("open"),children:"Add new domain and target"})}}),U(un,{get state(){return d()},get children(){return U(pn,{get children(){return[U(st,{children:"Add new domain and target"}),U(gn,{get children(){return[U(tn,{placeholder:"domain",label:"Domain:",value:r,onChange:e=>y("domain",e)}),U(tn,{placeholder:"distribution id",label:"Cloudfront Distribution ID:",value:i,onChange:e=>y("cloudfrontDistributionId",e)}),U(sn,{options:kn,value:s,onChange:e=>y("target",e)})]}}),U(Q,{when:u,get children(){return U(fn,{children:u})}}),U(hn,{get children(){return[U(ht,{onClick:()=>c("close"),children:"Cancel"}),U(ht,{get loading(){return h()},leftMargin:!0,get disabled(){return!r()||!s()},onClick:()=>b(),children:"Save"})]}})]}})}}),U(mn,{get children(){return[yn.cloneNode(!0),(()=>{const n=wn.cloneNode(!0);return ge(n,U(J,{get each(){return t.list},children:t=>(()=>{const n=xn.cloneNode(!0),r=n.firstChild,o=r.nextSibling,i=o.nextSibling,l=i.nextSibling;return ge(r,(()=>t.content.domain)),ge(o,(()=>t.content.cloudfrontDistributionId)),ge(i,(()=>t.content.target)),ge(l,(()=>t.content.siteId)),ge(n,U(bn,{get children(){return U(vn,{onClick:()=>(async t=>{try{await Ge(`${e.api}/delete-domain-setting.php`,{id:t}),await m()}catch(e){console.log(e)}})(t.externalId),children:"delete"})}}),null),n})()})),n})()]}})]}})},Cn=le("<span>, requested by <em></em></span>"),Pn=le("<span> - rejected by <em></em></span>"),jn=le("<span> - approved by <em></em></span>"),An=le("<em></em>"),Mn=Je("div")`
...
`,Dn=Je("div")`
    padding-left: 1rem;
    margin-top: 0.5rem;
`,Rn=e=>{const t=()=>{console.log("Request data: ",e.item)},n=`${e.item.content["wp-domain"]}${e.item.content.editorUrl}`;return U(Tn,{get key(){return e.item.content.post_id},get children(){return[U(Mn,{onClick:t,get children(){return e.item.content.type}}),U(_n,{get children(){return[U(qn,{href:n,target:"_blank",get children(){return e.item.content.post_title}}),U(Q,{get when(){return"admin"===e.type},get children(){const t=Cn.cloneNode(!0);return ge(t.firstChild.nextSibling,(()=>e.item.content.requestedBy)),t}}),U(Q,{get when(){return"rejected"===e.item.content.status},get children(){const t=Pn.cloneNode(!0);return ge(t.firstChild.nextSibling,(()=>e.item.content.rejectedBy)),t}}),U(Q,{get when(){return"approved"===e.item.content.status||"approvedAndPublished"===e.item.content.status},get children(){const t=jn.cloneNode(!0);return ge(t.firstChild.nextSibling,(()=>e.item.content.approvedBy)),t}}),ne((()=>` (${(()=>{const t=new Date(e.item.content.updated_on);return t.getFullYear()+"-"+(t.getMonth()+1).toString().padStart(2,"0")+"-"+t.getDate().toString().padStart(2,"0")+", "+t.getHours().toString().padStart(2,"0")+":"+t.getMinutes().toString().padStart(2,"0")})()})`)),U(Q,{get when(){return"rejected"===e.item.content.status},get children(){return U(Dn,{get children(){return[U(Nn,{children:"Rejection message:"}),(()=>{const t=An.cloneNode(!0);return ge(t,(()=>e.item.content.rejectionReason)),t})()]}})}})]}}),U(En,{get children(){return U(ht,{get onClick(){return e.manualDelete},children:"Delete"})}})]}})},$n=le("<p></p>"),Ln=le("<p>Reload page</p>"),zn=le("<div></div>"),Bn=Je("div")`
    margin-bottom: 3rem;
`,On=Je("div")`
    margin-top: 1rem;
    margin-bottom: 2rem;
...
`,Gn=Je("p")`
    font-size: 15px;
`,Zn=[{slug:"pending",name:"Pending"},{slug:"approved",name:"Approved"},{slug:"approvedAndPublished",name:"Published"},{slug:"rejected",name:"Rejected"}],er=({options:e})=>{const[t,n]=g([]),[r,o]=g([]),[i,l]=g([]),[s,a]=g([]),[d,c]=g("pending"),[u,p]=g(!1),[h,f]=g("");y((()=>{p(!0),v()}));const v=async()=>{try{var t;const n=await Ge(`${e.api}/get-publication-requests.php`);m(null==n||null===(t=n.data)||void 0===t?void 0:t.resources)}catch(e){console.log("Error fetching all publication requests",e),f("Error fetching all publication requests")}},m=(t=[])=>{const r={pending:{},approved:{},approvedAndPublished:{},rejected:{}};console.log("Unsorted requests",t);t.filter((t=>t.content.requestedBy===e.userName)).sort(((e,t)=>new Date(t.content.updated_on)-new Date(e.content.updated_on))).forEach((e=>{const t=e.content.status,n=b(e.content["wp-domain"]),o=e.content.from_site_name+" - "+n;r[t][o]||(r[t][o]=[]),r[t][o].push(e)})),console.log("Approved: ",r.approved),console.log("Approved And Published:",r.approvedAndPublished),console.log("Pending: ",r.pending),console.log("Rejected: ",r.rejected),n(r.approved),o(r.approvedAndPublished),a(r.rejected),l(r.pending),p(!1)},b=e=>{const t=e.indexOf("://");return e.slice(t+3)},w=({title:t,siteRequests:n})=>{const r=Object.keys(n);return U(Wn,{get children(){return[U(st,{children:t}),U(Q,{get when(){return 0!==r.length},get fallback(){return U(_n,{children:"None to show"})},get children(){return U(J,{each:r,children:t=>U(Xn,{get children(){return[U(Gn,{children:t}),U(J,{get each(){return n[t]},children:t=>U(Rn,{item:t,manualDelete:()=>(async t=>{console.log("Deleting publication request: "+t);try{var n;const o=await Ge(`${e.api}/delete-publication-request.php`,{postId:t});var r;if(console.log("Delete result",o),null!=o&&null!==(n=o.errors)&&void 0!==n&&n.length)throw new Error(null===(r=o.errors[0])||void 0===r?void 0:r.message);v()}catch(e){console.log("Error deleting publication request",e),f("Error deleting publication request")}})(t.content.post_id),type:"editor"})})]}})})}})]}})};return(()=>{const e=Vn.cloneNode(!0);return ge(e,U(it,{children:"My publication requests"}),null),ge(e,U(In,{get children(){return U(J,{each:Zn,children:(e,t)=>U(Fn,{get isActive(){return e.slug===d()},onClick:()=>c(e.slug),get children(){return e.name}})})}}),null),ge(e,U(Un,{get children(){return[(()=>{const e=ne((()=>!!u()),!0);return U(Q,{get when(){return e()&&!h()},get children(){return U(_n,{children:"Loading..."})}})})(),(()=>{const e=ne((()=>!("pending"!==d()||u())),!0);return U(Q,{get when(){return e()&&!h()},get children(){return w({title:"Pending",siteRequests:i()})}})})(),(()=>{const e=ne((()=>!("approved"!==d()||u())),!0);return U(Q,{get when(){return e()&&!h()},get children(){return w({title:"Approved",siteRequests:t()})}})})(),(()=>{const e=ne((()=>!("approvedAndPublished"!==d()||u())),!0);return U(Q,{get when(){return e()&&!h()},get children(){return w({title:"Published",siteRequests:r()})}})})(),(()=>{const e=ne((()=>!("rejected"!==d()||u())),!0);return U(Q,{get when(){return e()&&!h()},get children(){return w({title:"Rejected",siteRequests:s()})}})})(),U(Q,{get when(){return h()},get children(){return[(()=>{const e=Jn.cloneNode(!0);return ge(e,h),e})(),Qn.cloneNode(!0)]}})]}}),null),e})()},tr=e=>{try{return JSON.parse(document.getElementById(e).innerHTML)}catch(e){return console.log("Error in getData",e),{}}},nr=()=>{let e=document.getElementById("dls-metabox-root");if(e){const t=tr("dls-data");t.metaMenu="nav-menu"===e.getAttribute("data-type"),t.metaMenu&&(e=document.createElement("div"),e&&document.querySelector("#nav-menu-footer").prepend(e)),ie((()=>U(Xt,{options:t})),e)}};jQuery(document).ready((function(e){var t,n;const r=null===(t=wp)||void 0===t||null===(n=t.data)||void 0===n?void 0:n.dispatch("core/editor");r&&r.disablePublishSidebar(),(()=>{if(wp.data){let e=!1,t=!1;wp.data.subscribe((()=>{const n=wp.data.select("core/editor").isSavingPost(),r=wp.data.select("core/editor").isSavingNonPostEntityChanges&&wp.data.select("core/editor").isSavingNonPostEntityChanges();e!==n?(e=n,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved")):t!==r&&(t=r,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved"))}))}})();let o={};try{o=e("#dls-hooks").length>0?JSON.parse(e("#dls-hooks").html()):{hook:""}}catch(e){}console.log("Current hook",o&&o.hook),"post.php"===o.hook||"post-new.php"===o.hook||"nav-menus.php"===o.hook?nr():o.hook.includes("toplevel_page_draft-live-sync")?(()=>{const e=tr("dls-data");ie((()=>U(De,{values:e,get children(){return U(At,{})}})),document.getElementById("dls-root"))})():o.hook.includes("toplevel_page_cerberus-domain-settings")?(()=>{const e=document.getElementById("dls-domain-settings-root"),t=tr("dls-data");ie((()=>U(Sn,{options:t})),e)})():o.hook.includes("toplevel_page_publication-approval")?(()=>{const e=document.getElementById("dls-publication-approval-root"),t=tr("dls-data");ie((()=>U(Yn,{options:t})),e)})():o.hook.includes("toplevel_page_publication-requests")?(()=>{const e=document.getElementById("dls-publication-requests-root"),t=tr("dls-data");ie((()=>U(er,{options:t})),e)})():o.hook.includes(".php")||nr();const i=()=>{const e="true"===or("cerberus-activated"),t=document.querySelector("#toplevel_page_draft-live-sync");e&&t?t.style.display="block":t&&(t.style.display="none")};i();const l=document.querySelector("#cerberus-initiator");if(l){let e=0;l.addEventListener("click",(()=>{if(e++>9){"true"===or("cerberus-activated")?rr("cerberus-activated",!1,0):rr("cerberus-activated",!0,1e3),i(),e=0}}))}}));const rr=(e,t,n)=>{var r="";if(n){var o=new Date;o.setTime(o.getTime()+24*n*60*60*1e3),r="; expires="+o.toUTCString()}document.cookie=e+"="+(t||"")+r+"; path=/"},or=e=>{for(var t=e+"=",n=document.cookie.split(";"),r=0;r<n.length;r++){for(var o=n[r];" "==o.charAt(0);)o=o.substring(1,o.length);if(0==o.indexOf(t))return o.substring(t.length,o.length)}return null}}();
//# sourceMappingURL=draft-live-sync-boot-1.1.1.js.map
