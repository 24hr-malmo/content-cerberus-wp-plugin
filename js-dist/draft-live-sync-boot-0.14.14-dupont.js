...
`,Qe=()=>(x(Pe),F(Ke,{get children(){return[F(Je,{href:"#start",children:"Start"}),F(Je,{href:"#sync-check",children:"Sync Check"}),F(Je,{href:"#sync-draft",children:"Sync Draft"}),F(Je,{href:"#sync-live",children:"Sync Live"})]}})),Ve=async(e,t={})=>new Promise(((n,r)=>{jQuery.ajax({url:"/wp-admin/admin-ajax.php",type:"post",dataType:"json",data:{action:e,...t},success:function(e){n(e)},error:(e,t)=>{r(t)}})})),Xe=async(e,t)=>new Promise(((n,r)=>{jQuery.ajax({url:e,type:t?"post":"get",dataType:"json",data:t,success:function(e){n(e)},error:(e,t)=>{r(e.responseJSON)}})})),Ye=Ue("div")`
    ...
    border-radius: 3px;
    min-height: 50vh;
`,Ge=e=>F(Ye,{get children(){return e.children}}),We=Ue("div")`
    display: flex;
`,Ze=Ue("div")`
    flex: 1;
`,et=Ue("div")`
...
`,ot=Ue("h3")`
    ...
    margin-bottom: .5rem;
    margin-top: 0px;
`,it=e=>F(We,{get children(){return[F(Ze,{get children(){return[F(rt,{get children(){return e.title}}),F(tt,{get children(){return e.description}})]}}),F(et,{get children(){return e.actions}})]}});Ue("svg")`
    margin: auto; 
    background: white;
    display: block; 
...
`,dt=Ue("div")`
    position: absolute;
    right: 7px;
`,ut=e=>F(ct,K(e,{get children(){return[Z((()=>e.children)),F(Q,{get when(){return e.loading},get children(){return F(dt,{get children(){return F(at,{size:"small",get inverted(){return!e.disabled}})}})}})]}})),pt=Ue("div")`
    display: flex;
    margin-bottom: 2px;
`,ht=Ue("div")`
...
`,mt=re('<svg height="10" width="10"><circle cx="5" cy="5" r="5" stroke-width="0"></circle></svg>'),yt=({showCheckButton:e,showSyncButton:t,showDraft:n,showLive:r,item:o,onClick:i,onTypeClick:l})=>{const s=(e,t)=>{let n="#bbbbbb";return"error"===t?n="#da694b":""===t?n="#bbbbbb":e&&(n=e.synced?"#99da4b":"#e9da4e"),n};return F(pt,{get children(){return[F(Q,{when:n,get children(){return F(bt,{get color(){var e,t;return s(null===(e=o.status)||void 0===e?void 0:e.draft,null===(t=o.status)||void 0===t?void 0:t.state)},get children(){return mt.cloneNode(!0)}})}}),F(Q,{when:r,get children(){return F(bt,{get color(){var e,t;return s(null===(e=o.status)||void 0===e?void 0:e.live,null===(t=o.status)||void 0===t?void 0:t.state)},get children(){return mt.cloneNode(!0)}})}}),F(Q,{when:t,get children(){return F(ft,{onClick:i,children:"sync"})}}),F(Q,{when:e,get children(){return F(ft,{onClick:i,children:"check"})}}),F(ht,{onClick:()=>l(o.type),get children(){return o.type}}),F(gt,{target:"_new",get href(){return o.permalink},get children(){return o.permalink||"/"}})]}})},vt=re('<div style="padding-bottom:10px;"><label for="filter">Filter</label><input type="text" name="filter"></div>'),wt=re("<div></div>"),xt=({type:e})=>{const[t,{apiUrl:n}]=x(Pe),[r,o]=Te({list:[]}),[i,l]=Te({list:[]}),[s,a]=h(!1),[c,d]=h(!1);g((async()=>{const e=(await Ve("get_all_resources")).list.map(((e,t)=>({...e,index:t})));o({list:e}),l({list:e})}));const u=async(t,{syncTreeAndCache:r=!0})=>{try{(await Xe(`${n}/sync.php`,{action:"sync",permalink:t.permalink,release:e,sync_check:!1,sync_tree:r})).data?o("list",t.index,"status",{[e]:{synced:!0},state:"loaded"}):o("list",t.index,"status",{state:"error"})}catch(e){o("list",t.index,"status",{state:"error"})}},p=e=>{(e=>{if(""===e)return void l({list:r.list});const t=r.list.filter((t=>t.permalink.startsWith(e)));l({list:t})})(e.target.value)},f="draft"===e?"Begin to sync to Draft":"Publish list to Live",b="draft"===e?"Sync Draft":"Sync Live",m="draft"===e?"This is where you can make sure that wordpress and the draft content is in sync":"This is where you can make sure that Draft and Live are in sync";return F(Ge,{get children(){return[F(it,{title:b,description:m,get actions(){return(()=>{const t=wt.cloneNode(!0);return de(t,F(ut,{get loading(){return s()},onClick:()=>(async t=>{if(s())return;let n=!1;if(("live"===e&&confirm("Do you really want to publish the list?")||"draft"===e)&&(n=!0),n){a(!0),i.list.forEach(((e,t)=>{l("list",t,"status",{state:""}),t++}));for await(let e of r.list)await u(e,t);a(!1)}})({syncTreeAndCache:!1}),children:f}),null),de(t,F(ut,{get loading(){return c()},onClick:()=>(async()=>{try{d(!0);const t=await Xe(`${n}/recreate-tree.php`,{action:"recreate_tree",release:e});d(!1),window&&console.log(t),window&&window.alert("Recreating tree done - check console.log for response")}catch(e){window&&window.alert("Error recreating tree - check console.log")}})(),children:"Recreate tree, required after type/all syncs"}),null),t})()}}),(()=>{const e=vt.cloneNode(!0);return e.firstChild.nextSibling.$$input=p,e})(),F(J,{get each(){return i.list},children:t=>F(yt,{showDraft:"draft"===e,showLive:"live"===e,showSyncButton:!0,onClick:()=>(async(e,t)=>{a(!0),await u(e,t),a(!1)})(t,{syncTreeAndCache:!0}),onTypeClick:()=>(async(e,t)=>{a(!0);const n=i.list.filter((t=>t.type===e));n.forEach(((e,t)=>{l("list",t,"status",{state:""}),t++}));for await(let e of n)await u(e,t);a(!1)})(t.type,{syncTreeAndCache:!1}),item:t,get permalink(){return t.permalink}})})]}})};oe(["input"]);const kt=()=>{const[e,{apiUrl:t}]=x(Pe),[n,r]=Te({list:[]}),[o,i]=h(!1);g((async()=>{const e=(await Ve("get_all_resources")).list.map(((e,t)=>({...e,index:t})));r({list:e})}));const l=async e=>{try{const n=await Xe(`${t}/check-sync.php`,{permalink:e.permalink});r("list",e.index,"status",{draft:n.data.resourceStatus.find((e=>"draft"===e.target&&"__original"===e.comparedTo)),live:n.data.resourceStatus.find((e=>"live"===e.target&&"draft"===e.comparedTo)),state:"loaded"})}catch(t){r("list",e.index,"status",{state:"error"})}};return F(Ge,{get children(){return[F(it,{title:"Sync Check",description:"This is where you can check if all content is in sync",get actions(){return F(ut,{get loading(){return o()},onClick:()=>(async()=>{if(!o()){i(!0),n.list.forEach(((e,t)=>{r("list",t,"status",{state:""}),t++}));for await(let e of n.list)await l(e);i(!1)}})(),children:"Begin to check"})}}),F(J,{get each(){return n.list},children:e=>F(yt,{showDraft:!0,showLive:!0,showCheckButton:!0,item:e,get permalink(){return e.permalink},onClick:()=>(async e=>{i(!0),await l(e),i(!1)})(e),onTypeClick:()=>(async e=>{i(!0);const t=n.list.filter((t=>t.type===e));t.forEach(((e,t)=>{r("list",t,"status",{state:""}),t++}));for await(let e of t)await l(e);i(!1)})(e.type)})})]}})},St=Ue("p")`
    ...
    padding: 1rem 2rem;
    text-align: center;
`,Ct=()=>F(Ge,{get children(){return[F(it,{title:"Start",description:"This plugin lets you control and debug content through the content service."}),F(St,{children:"This is mainly used while developing or by admins!"})]}}),At=Ue("div")`
     color: black;
     max-width: 1200px;
     margin: 0 auto;
`;Ue("div")`
...
`,Lt=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,Nt=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return F($t,{get children(){return[F(Lt,{children:t}),F(Et,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},Dt=Ue("select")`
