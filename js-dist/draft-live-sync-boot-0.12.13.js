...
`,Ue("div")`
    font-size: 1rem;
    padding: 1rem 0;
`;const xt=()=>{const[e]=w(Pe);return I(vt,{get children(){return[I(et,{children:"Content Dashboard"}),I(Ke,{}),I(J,{get when(){return"sync-check"===e.path},get children(){return I(bt,{})}}),I(J,{get when(){return"sync-draft"===e.path},get children(){return I(mt,{type:"draft"})}}),I(J,{get when(){return"sync-live"===e.path},get children(){return I(mt,{type:"live"})}})]}})},wt=Ue("div")`
...
`,_t=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,Pt=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return I(jt,{get children(){return[I(_t,{children:t}),I(At,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},$t=Ue("select")`
