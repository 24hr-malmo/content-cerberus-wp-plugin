...
`;
  ...
  const PublishButton = () => {
    return createComponent(Button, {
      ...
      get disabled() {
        ...
        return contentStatus.changesNotSavedToDraft || ((_contentStatus$syncSt = contentStatus.syncStatus.live) === null || _contentStatus$syncSt === void 0 ? void 0 : _contentStatus$syncSt.synced);
      },

      get children() {
        var _contentStatus$syncSt2, _contentStatus$syncSt3, _contentStatus$syncSt4;

        return contentStatus.changesNotSavedToDraft ? (_contentStatus$syncSt2 = contentStatus.syncStatus.live) !== null && _contentStatus$syncSt2 !== void 0 && _contentStatus$syncSt2.exists ? 'Save draft before updating on live' : 'Save draft before publishing to live' : (_contentStatus$syncSt3 = contentStatus.syncStatus.live) !== null && _contentStatus$syncSt3 !== void 0 && _contentStatus$syncSt3.exists ? (_contentStatus$syncSt4 = contentStatus.syncStatus.live) !== null && _contentStatus$syncSt4 !== void 0 && _contentStatus$syncSt4.synced ? 'Updated on live site' : 'Update on live site' : 'Publish to live site';
      }
  ...
  const _tmpl$$4 = template(`<div><h5>Debug Panel</h5></div>`);
  ...
  const DebugPanel = () => {
    return (() => {
      ...
      _el$.style.setProperty("margin", '0.5rem');
  ...
  const PublishingControls = () => {
    return [createComponent(Show, {
      ...
      get children() {
        return [createComponent(Show, {
          get when() {
            return contentStatus.approvalStatus === '' || contentStatus.approvalStatus === 'rejected' || contentStatus.approvalStatus === 'approvedAndPublished';
          },
          ...
          get children() {
            return createComponent(Button, {
              ...
              get children() {
                return contentStatus.changesNotSavedToDraft ? 'Discard unapproved changes to publish' : 'Publish to live site';
              }
  ...
  const MetaBox = ({
    ...
    const publish = async e => {
      ...
      if (options.requireApproval === true && ((contentStatus === null || contentStatus === void 0 ? void 0 : contentStatus.approvalStatus) === 'pending' || (contentStatus === null || contentStatus === void 0 ? void 0 : contentStatus.approvalStatus) === 'approved')) {
          ...
          get children() {
            return [createComponent(Show, {
              ...
              get children() {
                ...
                }), memo(() => publishingControls()), createComponent(Show, {
                  get when() {
                    var _status$live3;
...
`;
  ...
  const PublicationRequestItem = props => {
    ...
    const getItemLink = () => {
      ...
      const itemLink = props.item.content.editorUrl.includes(domain) ? props.item.content.editorUrl : `${props.item.content['wp-domain']}${props.item.content.editorUrl}`;
      return itemLink;
    };
...
//# sourceMappingURL=draft-live-sync-boot-1.1.8.js.map
