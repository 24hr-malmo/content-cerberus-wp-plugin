...
`,Qe=()=>(x(Pe),F(Ke,{get children(){return[F(Je,{href:"#start",children:"Start"}),F(Je,{href:"#sync-check",children:"Sync Check"}),F(Je,{href:"#sync-draft",children:"Sync Draft"}),F(Je,{href:"#sync-live",children:"Sync Live"})]}})),Ve=async(e,t={})=>new Promise(((n,r)=>{jQuery.ajax({url:"/wp-admin/admin-ajax.php",type:"post",dataType:"json",data:{action:e,...t},success:function(e){n(e)},error:(e,t)=>{r(t)}})})),Xe=async(e,t)=>new Promise(((n,r)=>{jQuery.ajax({url:e,type:t?"post":"get",dataType:"json",data:t,success:function(e){n(e)},error:(e,t)=>{r(e.responseJSON)}})})),Ye=Ue("div")`
    ...
    border-radius: 3px;
    min-height: 50vh;
`,Ge=e=>F(Ye,{get children(){return e.children}}),Ze=Ue("div")`
    display: flex;
`,We=Ue("div")`
    flex: 1;
`,et=Ue("div")`
...
`,ot=Ue("h3")`
    ...
    margin-bottom: .5rem;
    margin-top: 0px;
`,it=e=>F(Ze,{get children(){return[F(We,{get children(){return[F(rt,{get children(){return e.title}}),F(tt,{get children(){return e.description}})]}}),F(et,{get children(){return e.actions}})]}});Ue("svg")`
    margin: auto; 
    background: white;
    display: block; 
...
`,dt=Ue("div")`
    position: absolute;
    right: 7px;
`,ut=e=>F(ct,K(e,{get children(){return[W((()=>e.children)),F(Q,{get when(){return e.loading},get children(){return F(dt,{get children(){return F(at,{size:"small",get inverted(){return!e.disabled}})}})}})]}})),ht=Ue("div")`
    display: flex;
    margin-bottom: 2px;
`,pt=Ue("div")`
...
`,bt=re('<svg height="10" width="10"><circle cx="5" cy="5" r="5" stroke-width="0"></circle></svg>'),mt=({showCheckButton:e,showSyncButton:t,showDraft:n,showLive:r,item:o,onClick:i,onTypeClick:l})=>{const s=(e,t)=>{let n="#bbbbbb";return"error"===t?n="#da694b":""===t?n="#bbbbbb":e&&(n=e.synced?"#99da4b":"#e9da4e"),n};return F(ht,{get children(){return[F(Q,{when:n,get children(){return F(yt,{get color(){var e,t;return s(null===(e=o.status)||void 0===e?void 0:e.draft,null===(t=o.status)||void 0===t?void 0:t.state)},get children(){return bt.cloneNode(!0)}})}}),F(Q,{when:r,get children(){return F(yt,{get color(){var e,t;return s(null===(e=o.status)||void 0===e?void 0:e.live,null===(t=o.status)||void 0===t?void 0:t.state)},get children(){return bt.cloneNode(!0)}})}}),F(Q,{when:t,get children(){return F(ft,{onClick:i,children:"sync"})}}),F(Q,{when:e,get children(){return F(ft,{onClick:i,children:"check"})}}),F(pt,{onClick:()=>l(o.type),get children(){return o.type}}),F(gt,{target:"_new",get href(){return o.permalink},get children(){return o.permalink||"/"}})]}})},vt=re("<div></div>"),wt=({type:e})=>{const[t,{apiUrl:n}]=x(Pe),[r,o]=Te({list:[]}),[i,l]=p(!1),[s,a]=p(!1);g((async()=>{const e=(await Ve("get_all_resources")).list.map(((e,t)=>({...e,index:t})));o({list:e})}));const c=async(t,{syncTreeAndCache:r=!0})=>{try{(await Xe(`${n}/sync.php`,{action:"sync",permalink:t.permalink,release:e,sync_check:!1,sync_tree:r})).data?o("list",t.index,"status",{[e]:{synced:!0},state:"loaded"}):o("list",t.index,"status",{state:"error"})}catch(e){o("list",t.index,"status",{state:"error"})}},d="draft"===e?"Begin to sync to Draft":"Publish everything to Live",u="draft"===e?"Sync Draft":"Sync Live",h="draft"===e?"This is where you can make sure that wordpress and the draft content is in sync":"This is where you can make sure that Draft and Live are in sync";return F(Ge,{get children(){return[F(it,{title:u,description:h,get actions(){return(()=>{const t=vt.cloneNode(!0);return de(t,F(ut,{get loading(){return i()},onClick:()=>(async t=>{if(i())return;let n=!1;if(("live"===e&&confirm("Do you really which to publish everything?")||"draft"===e)&&(n=!0),n){l(!0),r.list.forEach(((e,t)=>{o("list",t,"status",{state:""}),t++}));for await(let e of r.list)await c(e,t);l(!1)}})({syncTreeAndCache:!1}),children:d}),null),de(t,F(ut,{get loading(){return s()},onClick:()=>(async()=>{try{a(!0);const t=await Xe(`${n}/recreate-tree.php`,{action:"recreate_tree",release:e});a(!1),window&&console.log(t),window&&window.alert("Recreating tree done - check console.log for response")}catch(e){window&&window.alert("Error recreating tree - check console.log")}})(),children:"Recreate tree, required after type/all syncs"}),null),t})()}}),F(J,{get each(){return r.list},children:t=>F(mt,{showDraft:"draft"===e,showLive:"live"===e,showSyncButton:!0,onClick:()=>(async(e,t)=>{l(!0),await c(e,t),l(!1)})(t,{syncTreeAndCache:!0}),onTypeClick:()=>(async(e,t)=>{l(!0);const n=r.list.filter((t=>t.type===e));n.forEach(((e,t)=>{o("list",t,"status",{state:""}),t++}));for await(let e of n)await c(e,t);l(!1)})(t.type,{syncTreeAndCache:!1}),item:t,get permalink(){return t.permalink}})})]}})},xt=()=>{const[e,{apiUrl:t}]=x(Pe),[n,r]=Te({list:[]}),[o,i]=p(!1);g((async()=>{const e=(await Ve("get_all_resources")).list.map(((e,t)=>({...e,index:t})));r({list:e})}));const l=async e=>{try{const n=await Xe(`${t}/check-sync.php`,{permalink:e.permalink});r("list",e.index,"status",{draft:n.data.resourceStatus.find((e=>"draft"===e.target&&"__original"===e.comparedTo)),live:n.data.resourceStatus.find((e=>"live"===e.target&&"draft"===e.comparedTo)),state:"loaded"})}catch(t){r("list",e.index,"status",{state:"error"})}};return F(Ge,{get children(){return[F(it,{title:"Sync Check",description:"This is where you can check if all content is in sync",get actions(){return F(ut,{get loading(){return o()},onClick:()=>(async()=>{if(!o()){i(!0),n.list.forEach(((e,t)=>{r("list",t,"status",{state:""}),t++}));for await(let e of n.list)await l(e);i(!1)}})(),children:"Begin to check"})}}),F(J,{get each(){return n.list},children:e=>F(mt,{showDraft:!0,showLive:!0,showCheckButton:!0,item:e,get permalink(){return e.permalink},onClick:()=>(async e=>{i(!0),await l(e),i(!1)})(e),onTypeClick:()=>(async e=>{i(!0);const t=n.list.filter((t=>t.type===e));t.forEach(((e,t)=>{r("list",t,"status",{state:""}),t++}));for await(let e of t)await l(e);i(!1)})(e.type)})})]}})},kt=Ue("p")`
    font-size: 14px;
    padding-bottom: .5rem;
    ...
    padding: 1rem 2rem;
    text-align: center;
`,St=()=>F(Ge,{get children(){return[F(it,{title:"Start",description:"This plugin lets you control and debug content through the content service."}),F(kt,{children:"This is mainly used while developing or by admins!"})]}}),Ct=Ue("div")`
     color: black;
     max-width: 1200px;
     margin: 0 auto;
`;Ue("div")`
...
`,Lt=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,$t=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return F(Et,{get children(){return[F(Lt,{children:t}),F(Pt,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},Nt=Ue("select")`
...
`,Ot=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,zt=re("<option></option>"),qt=({options:e=[],placeholder:t="",label:n=" ",value:r,onChange:o=(()=>{})})=>{const i=e=>{console.log(e),o(e.target.value)};return F(Dt,{get children(){return[F(Ot,{children:n}),F(Nt,{get value(){return r()},placeholder:t,onChange:i,get children(){return F(J,{each:e,children:e=>(()=>{const t=zt.cloneNode(!0);return de(t,(()=>e.label)),f((n=>{const o=e.value,i=e.value===r();return o!==n._v$&&(t.value=n._v$=o),i!==n._v$2&&(t.selected=n._v$2=i),n}),{_v$:void 0,_v$2:void 0}),t})()})}})]}})},Bt={open:Fe`
    0% {
        max-height: 0;
    }
    100% {
...
`,Xt=Ue("td")`
    display: flex;
    justify-content: flex-end;
`,Yt=re("<thead><tr><th>Domain</th><th>Distribution ID</th><th>Target</th><th>SiteId</th><th></th></tr></thead>"),Gt=re("<tbody></tbody>"),Zt=re("<tr><td></td><td></td><td></td><td></td></tr>"),Wt=[{value:"draft",label:"Draft"},{value:"live",label:"Live"},{value:"test",label:"Test"}];const en=({options:e})=>{const[t,n]=Te({list:[]}),[r,o]=p(""),[i,l]=p(""),[s,a]=p("draft"),[c,d]=p("init"),[u,h]=p(""),[f,y]=p(!1),b=async()=>{const t=await Xe(`${e.api}/get-domain-settings.php`);n("list",t)},m=async(t=function(e){for(var t="",n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",r=n.length,o=0;o<e;o++)t+=n.charAt(Math.floor(Math.random()*r));return t}(20))=>{try{if(h(""),f())return;y(!0),await Xe(`${e.api}/upsert-domain-setting.php`,{domain:r(),target:s(),id:t,cloudfrontDistributionId:i()}),await b(),a("draft"),o(""),l(""),y(!1),d("close")}catch(e){console.log("ee",e),"domain-already-exists"===e.error?h("Domain already exists"):h("Something caused an error"),y(!1)}},v=(e,t)=>{"domain"===e&&o(t),"target"===e&&a(t),"cloudfrontDistributionId"===e&&l(t)};return g((()=>{b()})),F(It,{get children(){return[F(nt,{children:"Domain Settings"}),F(tt,{children:"This is the list of domains and targets that will be used for this site. You can add as many as you need but the domains need to be pointed to the server to make it work."}),F(Ht,{get children(){return F(ut,{onClick:()=>d("open"),children:"Add new domain and target"})}}),F(Ft,{get state(){return c()},get children(){return F(Rt,{get children(){return[F(ot,{children:"Add new domain and target"}),F(Ut,{get children(){return[F($t,{placeholder:"domain",label:"Domain:",value:r,onChange:e=>v("domain",e)}),F($t,{placeholder:"distribution id",label:"Cloudfront Distribution ID:",value:i,onChange:e=>v("cloudfrontDistributionId",e)}),F(qt,{options:Wt,value:s,onChange:e=>v("target",e)})]}}),F(Q,{when:u,get children(){return F(Jt,{children:u})}}),F(Kt,{get children(){return[F(ut,{onClick:()=>d("close"),children:"Cancel"}),F(ut,{get loading(){return f()},leftMargin:!0,get disabled(){return!r()||!s()},onClick:()=>m(),children:"Save"})]}})]}})}}),F(Vt,{get children(){return[Yt.cloneNode(!0),(()=>{const n=Gt.cloneNode(!0);return de(n,F(J,{get each(){return t.list},children:t=>(()=>{const n=Zt.cloneNode(!0),r=n.firstChild,o=r.nextSibling,i=o.nextSibling,l=i.nextSibling;return de(r,(()=>t.content.domain)),de(o,(()=>t.content.cloudfrontDistributionId)),de(i,(()=>t.content.target)),de(l,(()=>t.content.siteId)),de(n,F(Xt,{get children(){return F(Qt,{onClick:()=>(async t=>{try{await Xe(`${e.api}/delete-domain-setting.php`,{id:t}),await b()}catch(e){console.log(e)}})(t.externalId),children:"delete"})}}),null),n})()})),n})()]}})]}})},tn=e=>{try{return JSON.parse(document.getElementById(e).innerHTML)}catch(e){return{}}},nn=()=>{let e=document.getElementById("dls-metabox-root");if(e){const t=tn("dls-data");t.metaMenu="nav-menu"===e.getAttribute("data-type"),t.metaMenu&&(e=document.createElement("div"),e&&document.querySelector("#nav-menu-footer").prepend(e)),ne((()=>F(Tt,{options:t})),e)}};jQuery(document).ready((function(e){wp&&wp.data&&wp.data.dispatch&&wp.data.dispatch("core/editor").disablePublishSidebar(),(()=>{if(wp.data){let e=!1,t=!1;wp.data.subscribe((()=>{const n=wp.data.select("core/editor").isSavingPost(),r=wp.data.select("core/editor").isSavingNonPostEntityChanges&&wp.data.select("core/editor").isSavingNonPostEntityChanges();e!==n?(e=n,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved")):t!==r&&(t=r,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved"))}))}})();let t={};try{t=e("#dls-hooks").length>0?JSON.parse(e("#dls-hooks").html()):{hook:""}}catch(e){}console.log("Current hook",t&&t.hook),"post.php"===t.hook||"post-new.php"===t.hook||"nav-menus.php"===t.hook?nn():t.hook.includes("toplevel_page_draft-live-sync")?(()=>{const e=tn("dls-data");ne((()=>F(Ee,{values:e,get children(){return F(At,{})}})),document.getElementById("dls-root"))})():t.hook.includes("toplevel_page_cerberus-domain-settings")?(()=>{const e=document.getElementById("dls-domain-settings-root"),t=tn("dls-data");ne((()=>F(en,{options:t})),e)})():t.hook.includes(".php")||nn()}))}();
//# sourceMappingURL=draft-live-sync-boot-0.14.12-dupont.js.map
