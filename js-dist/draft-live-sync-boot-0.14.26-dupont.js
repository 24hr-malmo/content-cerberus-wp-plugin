...
`,jt=({options:e})=>{const[t,n]=$e({}),[r,o]=h(!0),[i,l]=h(!1),[s,a]=h(!1),[c,d]=h(!1),[u,p]=h(!1),[f,m]=h(!1),[b,y]=h(!1),[v,x]=h(!1),[w,k]=h(!1),S={permalink:e.permalink};let C,A;g((()=>{var t,n;e.metaMenu?(A=document.querySelector("#save_menu_footer"),T()):null!==(t=wp)&&void 0!==t&&null!==(n=t.data)&&void 0!==n&&n.select&&(C=wp.data.select("core/editor"),wp.domReady(M))})),g((()=>{wp&&wp.hooks&&wp.hooks.addAction&&(j(),wp.hooks.addAction("dls.post-saved","dls",(()=>{var e,n,r;if(null!=t&&null!==(e=t.draft)&&void 0!==e&&e.exists||null===(n=C)||void 0===n||!n.isPublishingPost())null!=t&&null!==(r=t.draft)&&void 0!==r&&r.exists&&(M(),j());else{const{isSavingPost:e}=C;let t=0;const n=setInterval((()=>{(!e()||t>=50)&&(location.reload(),clearInterval(n))}),100)}})))})),g((()=>{let e;document.addEventListener("cerberusListenerEvent",(t=>{var n;if(null!=t&&null!==(n=t.detail)&&void 0!==n&&n.hasChange){if(!e){if(e=document.querySelector(".editor-post-publish-button"),!e)return;e.addEventListener("click",(()=>{y(!1),e.setAttribute("disabled",!0)}))}e&&(y(!0),e.removeAttribute("disabled"))}}))}));const M=()=>{let e;const t=wp.data.subscribe(_.debounce((()=>{if(e||(e=document.querySelector(".editor-post-publish-button")),!e)return;const n=C.isEditedPostDirty(),r=C.hasNonPostEntityChanges(),o=b();r||n||o?(p(!0),e.removeAttribute("disabled"),t()):(p(!1),e.setAttribute("disabled",!0))}),100))},T=()=>{let e,t=!1;A.setAttribute("disabled",!0);let n=()=>{t||clearInterval(e)},r=()=>{t||(e=o())};const o=()=>setInterval((()=>{var o,i;null!==(o=window)&&void 0!==o&&null!==(i=o.wpNavMenu)&&void 0!==i&&i.menusChanged&&(t=!0,$(),clearInterval(e),window.removeEventListener("blur",n),window.removeEventListener("focus",r))}),500);e=o(),window.addEventListener("blur",n),window.addEventListener("focus",r)},$=()=>{A.removeAttribute("disabled"),m(!0)},j=async(t=!0)=>{t&&(o(!0),await new Promise((e=>setTimeout(e,1e3))));try{var r;const t=await Ze("check_sync",{...S,api_path:S.permalink});if(null==t||null===(r=t.data)||void 0===r||!r.resourceStatus)throw S;n({draft:t.data.resourceStatus.find((e=>"draft"===e.target&&"__original"===e.comparedTo)),live:t.data.resourceStatus.find((e=>"live"===e.target&&"draft"===e.comparedTo)),state:"loaded"}),k(!1),e.metaMenu&&N()}catch(e){console.log("--- meta-box --- Can't find any data with check-sync of payload: ",e),k(!0),o(!1),n({state:"error"})}o(!1)},N=async()=>{var n;const r=document.querySelectorAll(".menu-theme-locations > .menu-settings-input"),o=document.querySelector(".menu-settings-group.menu-theme-locations"),i=document.createElement("i");i.classList.add("changes-disabled-message");const l=null===(n=t.draft)||void 0===n?void 0:n.exists,s=t.live&&t.live.exists;!l||s?(o.style.pointerEvents="none",o.style.cursor="not-allowed",o.style.opacity=.5):(o.style.pointerEvents="auto",o.style.cursor="default",o.style.opacity=1);const a=document.querySelector(".changes-disabled-message");if(s){const e="Menu must be unpublished before toggling location";a?a.innerHTML=e:(i.innerHTML=e,o.prepend(i))}else{const e="Menu must be created before toggling location";l?a&&a.parentNode.removeChild(a):a?a.innerHTML=e:(i.innerHTML=e,o.prepend(i))}let c=!1,u=!1,p=!1;for(let t of r){const n=t.querySelector("input");n.addEventListener("change",(()=>{d(!0),$()}));const r=t.querySelector(".theme-location-set"),o=null!==n.getAttribute("checked"),i=n.value,l=(e.locationLanguages||{})[i]||"",s=e.menuLanguage||"";if(r&&!o){!l&&!s||l===s?(n.setAttribute("disabled",!0),t.style.pointerEvents="none",t.style.opacity=.5,u=!0):p=!0}o&&(c=!0)}if(u&&!s&&l){const e=document.querySelector(".changes-disabled-message"),t="Some locations cannot be set because they are already set in this language";e?e.innerHTML=t:(i.innerHTML=t,o.prepend(i))}else if(p&&!s&&l){const e=document.querySelector(".changes-disabled-message"),t="Note: Some locations are set in other languages";e?(e.innerHTML=t,e.style.color="#2271b1",e.style.fontStyle="normal"):(i.innerHTML=t,i.style.color="#2271b1",i.style.fontStyle="normal",o.prepend(i))}if(location.search.includes("menu=0"))return;x(!0);const h=document.querySelector(".submitdelete.deletion.menu-delete");let f=document.querySelector(".delete-link-replacement");c||s?(h.style.display="none",f?f.style.display="inline":(f=document.createElement("span"),f.classList.add("delete-link-replacement"),f.innerHTML="To delete a menu it must be unpublished (and unregisterered from all display locations)",f.style.color="#a7aaad",f.style.fontSize="12px"),h.parentNode.prepend(f)):(h.style.display="inline",f&&(f.style.display="none"))},P=(e={})=>{if(document){const t=new CustomEvent("cerberusChangeEvent",{detail:e});document.dispatchEvent(t)}},L=async e=>{e.preventDefault(),e.stopPropagation(),l(!0);(await Ze("publish_to_live",S)).data?j(!1):n({state:"error"}),await new Promise((e=>setTimeout(e,1e3))),l(!1),P({action:"publish_to_live_done"})},E=async e=>{e.preventDefault(),e.stopPropagation(),a(!0);(await Ze("unpublish_from_live",S)).data?j(!1):n({state:"error"}),await new Promise((e=>setTimeout(e,1e3))),a(!1),P({action:"unpublish_from_live_done"})};return F(Mt,{get horizontal(){return e.metaMenu},get box(){return e.optionsMeta},get children(){return[F(Q,{get when(){return r()},get children(){return F(Tt,{get horizontal(){return e.metaMenu},get children(){return[F(at,{get size(){return e.metaMenu?"small":"large"}}),F($t,{children:"Checking content in draft and live"})]}})}}),F(Q,{get when(){return!r()},get children(){return[F(Q,{get when(){return w()},get children(){return F(Tt,{get horizontal(){return e.metaMenu},get children(){return F($t,{children:"Content must be saved before publishing"})}})}}),F(Q,{get when(){var e;return!c()&&(null===(e=t.draft)||void 0===e?void 0:e.exists)},get children(){return[F($t,{get horizontal(){return e.metaMenu},children:"Publish content"}),F(Q,{get when(){var e;return!(null!==(e=t.live)&&void 0!==e&&e.exists)},get children(){return[F(ut,{get leftMargin(){return e.metaMenu},get loading(){return i()},onClick:e=>L(e),get disabled(){return u()||f()||b()},get children(){return u()||f()||b()?"Save draft before publishing to live":"Publish to live site"}}),F(ut,{get leftMargin(){return e.metaMenu},get disabled(){var e;return!(null!==(e=t.live)&&void 0!==e&&e.synced)},children:"Content not published"})]}}),F(Q,{get when(){var e;return null===(e=t.live)||void 0===e?void 0:e.exists},get children(){return[F(ut,{get leftMargin(){return e.metaMenu},get loading(){return i()},onClick:e=>L(e),get disabled(){var e;return(null===(e=t.live)||void 0===e?void 0:e.synced)||u()||f()||b()},get children(){var e;return u()||f()||b()?"Save draft before updating on live":null!==(e=t.live)&&void 0!==e&&e.synced?"Updated on live site":"Update on live site"}}),F(ut,{get leftMargin(){return e.metaMenu},get loading(){return s()},onClick:e=>E(e),get disabled(){return b()},children:"Unpublish"})]}})]}}),F(Q,{get when(){return e.metaMenu},get children(){return F(Tt,{get horizontal(){return e.metaMenu},get children(){return[F(Q,{get when(){return!v()},get children(){return F($t,{children:"Enter a 'Menu Name' above to create a new menu"})}}),(()=>{const e=W((()=>{var e;return!(c()||null!==(e=t.draft)&&void 0!==e&&e.exists)}),!0);return F(Q,{get when(){return e()&&v()},get children(){return F($t,{children:"Save menu with menu items in order to publish"})}})})(),F(Q,{get when(){return c()},get children(){return F($t,{children:"Save the changes before publishing"})}})]}})}})]}}),F(Q,{get when(){return e.enableTestContent},get children(){return F(ut,{get leftMargin(){return e.metaMenu},get loading(){return s()},onClick:e=>E(e),get disabled(){var e;return!(null!==(e=t.test)&&void 0!==e&&e.synced)},get children(){return t.test&&t.test.synced?"Unpublish from test target":"Publish to test target"}})}}),F(Q,{get when(){return e.enableDiffButton},get children(){return F(ut,{get leftMargin(){return e.metaMenu},children:"Show diff (raw)"})}})]}})},Nt=Ue("input")`
`,Pt=Ue("div")`
    display: flex;
    flex-direction: column;
    width: 100%;
...
`,Lt=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,Et=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return F(Pt,{get children(){return[F(Lt,{children:t}),F(Nt,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},Dt=Ue("select")`
