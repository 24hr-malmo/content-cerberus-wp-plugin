...
`,$t=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,Pt=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return I(_t,{get children(){return[I($t,{children:t}),I(jt,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},Tt=Ue("select")`
...
`,Nt=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,zt=te("<option></option>"),Mt=({options:e=[],placeholder:t="",label:n=" ",value:r,onChange:o=(()=>{})})=>{const i=e=>{console.log(e),o(e.target.value)};return I(Ot,{get children(){return[I(Nt,{children:n}),I(Tt,{get value(){return r()},placeholder:t,onChange:i,get children(){return I(R,{each:e,children:e=>(()=>{const t=zt.cloneNode(!0);return ae(t,(()=>e.label)),f((n=>{const o=e.value,i=e.value===r();return o!==n._v$&&(t.value=n._v$=o),i!==n._v$2&&(t.selected=n._v$2=i),n}),{_v$:void 0,_v$2:void 0}),t})()})}})]}})},Lt={open:Fe`
    0% {
        max-height: 0;
    }
    100% {
