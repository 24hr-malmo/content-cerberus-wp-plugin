...
`,Et=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,Lt=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return F(Nt,{get children(){return[F(Et,{children:t}),F(Pt,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},Dt=Ue("select")`
...
`,Ot=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,It=re("<option></option>"),qt=({options:e=[],placeholder:t="",label:n=" ",value:r,onChange:o=(()=>{})})=>{const i=e=>{console.log(e),o(e.target.value)};return F(zt,{get children(){return[F(Ot,{children:n}),F(Dt,{get value(){return r()},placeholder:t,onChange:i,get children(){return F(J,{each:e,children:e=>(()=>{const t=It.cloneNode(!0);return de(t,(()=>e.label)),f((n=>{const o=e.value,i=e.value===r();return o!==n._v$&&(t.value=n._v$=o),i!==n._v$2&&(t.selected=n._v$2=i),n}),{_v$:void 0,_v$2:void 0}),t})()})}})]}})},Bt={open:Fe`
    0% {
        max-height: 0;
    }
    100% {
...
`,Yt=Ue("div")`
    margin-left: 2rem;
`,Gt=re("<thead><tr><th>Domain</th><th>Distribution ID</th><th>Target</th><th>SiteId</th><th>Delete</th><th>Do not index</th><th>Save</th></tr></thead>"),Wt=re("<tbody></tbody>"),en=re('<input type="checkbox">'),tn=re("<tr><td></td><td></td><td></td><td></td><td></td></tr>"),nn=[{value:"draft",label:"Draft"},{value:"live",label:"Live"},{value:"test",label:"Test"}];const rn=({options:e})=>{const[t,n]=Me({list:[]}),[r,o]=h(""),[i,l]=h(""),[s,a]=h("draft"),[c,d]=h("init"),[u,p]=h(""),[m,b]=h(!1),v=async()=>{const t=await Ve(`${e.api}/get-domain-settings.php`);t.sort(((e,t)=>e.key.localeCompare(t.key))),n("list",t)},y=async(t=function(e){for(var t="",n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",r=n.length,o=0;o<e;o++)t+=n.charAt(Math.floor(Math.random()*r));return t}(20))=>{try{const n=function(e){const t=e.match(/^(?:https?:\/\/)?(?:www\.)?([^\/\n]+)/);if(t){const e=t[1];return/^[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}$/.test(e)?e:null}return null}(r());if(null===n)return void p("Invalid domain. Please enter a valid domain without http(s):// or path.");if(p(""),m())return;b(!0),await Ve(`${e.api}/upsert-domain-setting.php`,{domain:n,target:s(),id:t,cloudfrontDistributionId:i()}),await v(),a("draft"),o(""),l(""),b(!1),d("close")}catch(e){console.log("ee",e),"domain-already-exists"===e.error?p("Domain already exists"):p("Something caused an error"),b(!1)}},x=(e,t)=>{"domain"===e&&o(t),"target"===e&&a(t),"cloudfrontDistributionId"===e&&l(t)};g((()=>{v()}));const w=async(n,r)=>{const o=t.list.find((e=>e.externalId===n));o&&(await Ve(`${e.api}/upsert-domain-setting.php`,{domain:o.content.domain,target:o.content.target,id:o.externalId,cloudfrontDistributionId:o.content.cloudfrontDistributionId,doNotIndex:r.doNotIndex}),await v())};return F(Ht,{get children(){return[F(nt,{children:"Domain Settings"}),F(tt,{children:"This is the list of domains and targets that will be used for this site. You can add as many as you need but the domains need to be pointed to the server to make it work."}),F(Ft,{get children(){return F(ut,{onClick:()=>d("open"),children:"Add new domain and target"})}}),F(Rt,{get state(){return c()},get children(){return F(Ut,{get children(){return[F(ot,{children:"Add new domain and target"}),F(Kt,{get children(){return[F(Lt,{placeholder:"domain",label:"Domain:",value:r,onChange:e=>x("domain",e)}),F(Lt,{placeholder:"distribution id",label:"Cloudfront Distribution ID:",value:i,onChange:e=>x("cloudfrontDistributionId",e)}),F(qt,{options:nn,value:s,onChange:e=>x("target",e)})]}}),F(Q,{when:u,get children(){return F(Qt,{children:u})}}),F(Jt,{get children(){return[F(ut,{onClick:()=>d("close"),children:"Cancel"}),F(ut,{get loading(){return m()},leftMargin:!0,get disabled(){return!r()||!s()},onClick:()=>y(),children:"Save"})]}})]}})}}),F(Vt,{get children(){return[Gt.cloneNode(!0),(()=>{const r=Wt.cloneNode(!0);return de(r,F(J,{get each(){return t.list},children:(r,o)=>(()=>{const i=tn.cloneNode(!0),l=i.firstChild,s=l.nextSibling,a=s.nextSibling,c=a.nextSibling,d=c.nextSibling;return de(l,(()=>r.content.domain)),de(s,(()=>r.content.cloudfrontDistributionId)),de(a,(()=>r.content.target)),de(c,(()=>r.content.siteId)),de(i,F(Xt,{get children(){return F(Zt,{onClick:()=>(async t=>{try{await Ve(`${e.api}/delete-domain-setting.php`,{id:t}),await v()}catch(e){console.log(e)}})(r.externalId),children:"delete"})}}),d),de(d,F(Yt,{get children(){const e=en.cloneNode(!0);return e.addEventListener("change",(e=>{const r=e.target.checked;(async(e,r)=>{b(!0),n("list",e,"content","doNotIndex",r);const o=t.list[e];await w(o.externalId,{...o.content,doNotIndex:r}),b(!1)})(o(),r)})),f((t=>{const n=r.content.doNotIndex,o=m();return n!==t._v$&&(e.checked=t._v$=n),o!==t._v$2&&(e.disabled=t._v$2=o),t}),{_v$:void 0,_v$2:void 0}),e}})),i})()})),r})()]}})]}})},on=e=>{try{return JSON.parse(document.getElementById(e).innerHTML)}catch(e){return{}}},ln=()=>{let e=document.getElementById("dls-metabox-root");if(e){const t=on("dls-data");t.metaMenu="nav-menu"===e.getAttribute("data-type"),t.metaMenu&&(e=document.createElement("div"),e&&document.querySelector("#nav-menu-footer").prepend(e)),ne((()=>F(Tt,{options:t})),e)}};jQuery(document).ready((function(e){wp&&wp.data&&wp.data.dispatch&&wp.data.dispatch("core/editor").disablePublishSidebar(),(()=>{if(wp.data){let e=!1,t=!1;wp.data.subscribe((()=>{const n=wp.data.select("core/editor").isSavingPost(),r=wp.data.select("core/editor").isSavingNonPostEntityChanges&&wp.data.select("core/editor").isSavingNonPostEntityChanges();e!==n?(e=n,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved")):t!==r&&(t=r,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved"))}))}})();let t={};try{t=e("#dls-hooks").length>0?JSON.parse(e("#dls-hooks").html()):{hook:""}}catch(e){}console.log("Current hook",t&&t.hook),"post.php"===t.hook||"post-new.php"===t.hook||"nav-menus.php"===t.hook?ln():t.hook.includes("toplevel_page_draft-live-sync")?(()=>{const e=on("dls-data");ne((()=>F(Pe,{values:e,get children(){return F(_t,{})}})),document.getElementById("dls-root"))})():t.hook.includes("toplevel_page_cerberus-domain-settings")?(()=>{const e=document.getElementById("dls-domain-settings-root"),t=on("dls-data");ne((()=>F(rn,{options:t})),e)})():t.hook.includes(".php")||ln()}))}();
//# sourceMappingURL=draft-live-sync-boot-0.14.22-dupont.js.map
