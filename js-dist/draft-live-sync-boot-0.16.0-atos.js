...
`,ft=Ve("div")`
    position: absolute;
    right: 7px;
`,vt=e=>K(ht,Y(e,{get children(){return[oe((()=>e.children)),K(W,{get when(){return e.loading},get children(){return K(ft,{get children(){return K(gt,{size:"small",get inverted(){return!e.disabled}})}})}})]}})),bt=Ve("div")`
    display: flex;
    margin-bottom: 2px;
`,mt=Ve("div")`
