...
`;
  ...
  const _tmpl$$4 = template(`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"><circle cx="50" cy="50" r="32" stroke-width="8" stroke-dasharray="50.26548245743669 50.26548245743669" fill="none" stroke-linecap="round"><animateTransform attributeName="transform" type="rotate" repeatCount="indefinite" dur="2.0408163265306123s" keyTimes="0;1" values="0 50 50;360 50 50"></animateTransform></circle></svg>`);
  const sizes = {
    small: '20px',
    medium: '30px',
    large: '50px',
...
`;
  ...
  const _tmpl$$3 = template(`<svg height="10" width="10"><circle cx="5" cy="5" r="5" stroke-width="0"></circle></svg>`);
  ...
  const _tmpl$$2 = template(`<div style="padding-bottom:10px;"><label for="filter">Filter</label><input type="text" name="filter"></div>`),
  ...
  const SyncContent = ({
    ...
    const [filteredItems, setFilteredItems] = createStore({
      list: []
    });
        ...
        return [createComponent(PageTop, {
          ...
          get actions() {
            return (() => {
              ...
              insert(_el$4, createComponent(Button, {
                get loading() {
                  return createTreeChecking();
                },

                onClick: () => recreateTree(),
                children: "Recreate tree, required after type/all syncs"
              }), null);
...
`;
  ...
  const MetaBox = ({
    ...
    const [noContentFound, setNoContentFound] = createSignal(false); // Not sure if it's better to use post_id here, since we are sending it in to the MetaBox options
                ...
                return [createComponent(StyledStatusText, {
                  ...
                  get children() {
                    return [createComponent(Button, {
                      ...
                      get children() {
                        return unsavedPageChanges() || unsavedMenuChanges() || unsavedExternalChange() ? 'Save draft before publishing to live' : 'Publish to live site';
                      }
                  ...
                  get children() {
                    return [createComponent(Button, {
                      ...
                      get disabled() {
                        ...
                        return ((_status$live4 = status.live) === null || _status$live4 === void 0 ? void 0 : _status$live4.synced) || unsavedPageChanges() || unsavedMenuChanges() || unsavedExternalChange();
                      },

                      get children() {
                        var _status$live5;

                        return unsavedPageChanges() || unsavedMenuChanges() || unsavedExternalChange() ? 'Save draft before updating on live' : (_status$live5 = status.live) !== null && _status$live5 !== void 0 && _status$live5.synced ? 'Updated on live site' : 'Update on live site';
                      }
...
`;
  ...
  function sanitizeDomain(domain) {
    ...
    const match = domain.match(domainRegex); // Check if we found a match
...
//# sourceMappingURL=draft-live-sync-boot-0.14.19-dupont.js.map
