...
`,Ge=Qe("a")`
    ...
    display: block;
    padding: 0 1rem;
`,Ve=()=>(k(Ee),U(Ye,{get children(){return[U(Ge,{href:"#start",children:"Start"}),U(Ge,{href:"#sync-check",children:"Sync Check"}),U(Ge,{href:"#sync-draft",children:"Sync Draft"}),U(Ge,{href:"#sync-live",children:"Sync Live"})]}})),We=async(e,t={})=>new Promise(((n,r)=>{jQuery.ajax({url:"/wp-admin/admin-ajax.php",type:"post",dataType:"json",data:{action:e,...t},success:function(e){n(e)},error:(e,t)=>{r(t)}})})),Xe=async(e,t)=>new Promise(((n,r)=>{jQuery.ajax({url:e,type:t?"post":"get",dataType:"json",data:t,success:function(e){n(e)},error:(e,t)=>{r(e.responseJSON||t)}})})),Ze=Qe("div")`
...
`,[Et,Tt]=De({options:{},setChecking:()=>!0,syncStatus:{},publish:()=>null,changesNotSavedToDraft:!1,showRejectionControls:!1,rejectionReason:"",approvalStatus:"",errorMessage:"",approvedBy:""}),Rt=e=>{Tt({approvalStatus:e})},$t=()=>{Tt((e=>({showRejectionControls:!e.showRejectionControls})))},Lt=async(e="")=>{Et.setChecking(!0);const t=await(async e=>{console.log("Creating/updating pub request for "+Et.options.permalink+": ",Et);try{var t;return await Xe(`${Et.options.api}/upsert-publication-request.php`,{permalink:Et.options.permalink,status:e,editorUrl:null===(t=window)||void 0===t?void 0:t.location.href,approvedBy:"approved"===e?Et.options.userName:"",rejectedBy:"rejected"===e?Et.options.userName:"",requestedBy:"pending"===e?Et.options.userName:Et.requestedBy,rejectionReason:Et.rejectionReason}),{}}catch(e){return console.log("Error upserting publication request",e),{err:e}}})(e);t.err?(Tt({errorMessage:"Error changing status to "+e}),console.log("Err upserting request",t.err)):Rt(e),Et.setChecking(!1),"approved"!==e&&"rejected"!==e||zt()},zt=async()=>{const{postTitle:e,rejectionReason:t,approvalStatus:n,editorEmail:r}=Et,{userName:o,siteTitle:i}=Et.options;try{var l;await Xe(`${Et.options.api}/send-publication-approval-email.php`,{data:{useCustomMailSystem:Et.options.useCustomSmtp,postTitle:e,rejectionReason:t,approvalStatus:n,admin:o,editorEmail:r,siteTitle:i,postUrl:null===(l=window)||void 0===l?void 0:l.location.href}})}catch(e){console.log("Error sending email")}},Bt=async()=>{Et.setChecking(!0);const e=await(async()=>{console.log("Deleting pub request for "+Et.options.permalink+": ",Et);try{var e,t;const o=await Xe(`${Et.options.api}/delete-publication-request.php`,{postId:Et.options.postId});var n,r;return null!=o&&null!==(e=o.data)&&void 0!==e&&null!==(t=e.deleteResource)&&void 0!==t&&t.success||console.log("Unable to delete publication request because: ",null==o||null===(n=o.errors)||void 0===n||null===(r=n[0])||void 0===r?void 0:r.message),{}}catch(e){return console.log("Error deleting request",e),{err:e}}})();e.err?(Tt({errorMessage:"Something went wrong withdrawing publication request"}),console.log("Err deleting request",e.err)):Rt(""),Et.setChecking(!1)},Ot=le("<em></em>"),It=Qe("div")`
    padding: 0.25rem;
    background: #fefbe6;
`,Ht=()=>U(G,{get children(){return[U(V,{get when(){return"pending"===Et.approvalStatus},get children(){return U(Dt,{get horizontal(){return Et.options.metaMenu},children:"Pending approval"})}}),U(V,{get when(){return"approved"===Et.approvalStatus},get children(){return U(Dt,{get horizontal(){return Et.options.metaMenu},get children(){return["Publication approved ",ne((()=>Et.approvedBy?" by "+Et.approvedBy:""))]}})}}),U(V,{get when(){return"rejected"===Et.approvalStatus},get children(){return[U(Dt,{get horizontal(){return Et.options.metaMenu},get children(){return["Publication rejected ",ne((()=>Et.rejectedBy?" by "+Et.rejectedBy:""))]}}),U(Y,{get when(){return Et.rejectionReason},get children(){return U(It,{get children(){const e=Ot.cloneNode(!0);return ge(e,(()=>Et.rejectionReason)),e}})}})]}})]}}),Ut=()=>U(ht,{get leftMargin(){return Et.options.metaMenu},get loading(){return Et.publishing},onClick:e=>Et.publish(e),get disabled(){return Et.changesNotSavedToDraft},get children(){var e,t,n;return Et.changesNotSavedToDraft?null!==(e=Et.syncStatus.live)&&void 0!==e&&e.exists?"Save draft before updating on live":"Save draft before publishing to live":null!==(t=Et.syncStatus.live)&&void 0!==t&&t.exists?null!==(n=Et.syncStatus.live)&&void 0!==n&&n.synced?"Updated on live site":"Update on live site":"Publish to live site"}}),Ft=le('<div><h4>Rejection reason</h4><textarea rows="4" placeholder="Message to the editor" maxlength="200"></textarea><div></div></div>'),Kt=()=>[U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>Lt("approved"),get disabled(){return Et.showRejectionControls},children:"Approve "}),U(Y,{get when(){return!Et.showRejectionControls},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>{$t()},get disabled(){return Et.showRejectionControls},children:"Reject"})}}),U(Y,{get when(){return Et.showRejectionControls},get children(){const e=Ft.cloneNode(!0),t=e.firstChild,n=t.nextSibling,r=n.nextSibling;return e.style.setProperty("margin-block","1.5rem"),t.style.setProperty("margin-bottom",0),n.addEventListener("change",(e=>{var t;t=e.target.value,Tt({rejectionReason:t})})),n.style.setProperty("width","100%"),n.style.setProperty("margin-top","0.5rem"),r.style.setProperty("display","flex"),ge(r,U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>$t(),disabled:!1,style:{"margin-top":0,"margin-right":"0.2rem"},children:"Cancel"}),null),ge(r,U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>Lt("rejected"),disabled:!1,style:{"margin-top":0},children:"Send rejection"}),null),e}}),U(Y,{get when(){return!Et.showRejectionControls},get children(){return U(Ut,{})}})],Jt=le("<div><h5>Dev mode</h5></div>"),Qt=()=>(()=>{const e=Jt.cloneNode(!0);return e.firstChild,e.style.setProperty("background","lightgray"),e.style.setProperty("padding","0.5rem"),ge(e,U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>Lt("approved"),disabled:!1,children:"Approve"}),null),ge(e,U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>Lt("rejected"),disabled:!1,children:"Reject"}),null),ge(e,U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>Lt("pending"),get disabled(){return Et.changesNotSavedToDraft},children:"Set to pending"}),null),e})(),Yt=()=>[U(Y,{get when(){return""===Et.approvalStatus},get children(){return[U(Y,{get when(){return Et.options.userHasPublicationRights},get children(){return U(Ut,{})}}),U(Y,{get when(){return!Et.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>Lt("pending"),get disabled(){return Et.changesNotSavedToDraft},get children(){return Et.changesNotSavedToDraft?"Save draft before publishing request":"Request approval to publish"}})}})]}}),U(Y,{when:false,get children(){return U(Qt,{})}}),U(Y,{get when(){return"pending"===Et.approvalStatus},get children(){return[U(Y,{get when(){return Et.options.userHasPublicationRights},get children(){return U(Kt,{})}}),U(Y,{get when(){return!Et.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>Bt(),disabled:!1,children:"Withdraw publication request"})}})]}}),U(Y,{get when(){return"approved"===Et.approvalStatus},get children(){return[U(Y,{get when(){return Et.options.userHasPublicationRights},get children(){return U(Ut,{})}}),U(Y,{get when(){return!Et.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},get loading(){return Et.publishing},onClick:e=>Et.publish(e),get disabled(){return Et.changesNotSavedToDraft},get children(){return Et.changesNotSavedToDraft?"Discard unapproved changes to publish":"Publish to live site"}})}})]}}),U(Y,{get when(){return"rejected"===Et.approvalStatus},get children(){return U(Y,{get when(){return Et.options.userHasPublicationRights},get children(){return U(Ut,{})}})}})],Gt=()=>U(Y,{get when(){return"pending"===Et.approvalStatus&&Et.changesNotSavedToDraft},get children(){return U(Nt,{children:"Saving a new draft will automatically withdraw the pending publication approval"})}}),Vt=()=>[U(Y,{get when(){return""===Et.approvalStatus},get children(){return[U(Y,{get when(){return Et.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},get loading(){return Et.publishing},onClick:e=>Et.publish(e),get disabled(){var e;return(null===(e=Et.syncStatus.live)||void 0===e?void 0:e.synced)||Et.changesNotSavedToDraft},get children(){var e;return Et.changesNotSavedToDraft?"Save draft before updating on live":null!==(e=Et.syncStatus.live)&&void 0!==e&&e.synced?"Updated on live site":"Update on live site"}})}}),U(Y,{get when(){return!Et.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},get loading(){return Et.publishing},onClick:e=>Lt("pending"),get disabled(){var e;return(null===(e=Et.syncStatus.live)||void 0===e?void 0:e.synced)||Et.changesNotSavedToDraft},get children(){var e;return Et.changesNotSavedToDraft?"Save draft before requesting publication approval":null!==(e=Et.syncStatus.live)&&void 0!==e&&e.synced?"Updated on live site":"Request approval to publish"}})}})]}}),U(Y,{get when(){return"pending"===Et.approvalStatus},get children(){return[U(Y,{get when(){return Et.options.userHasPublicationRights},get children(){return U(Kt,{})}}),U(Y,{get when(){return!Et.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>Bt(),disabled:!1,children:"Withdraw publication request"})}})]}}),U(Y,{get when(){return"approved"===Et.approvalStatus},get children(){return[U(Y,{get when(){return Et.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},get loading(){return Et.publishing},onClick:e=>Et.publish(e),get disabled(){var e;return(null===(e=Et.syncStatus.live)||void 0===e?void 0:e.synced)||Et.changesNotSavedToDraft},get children(){var e;return Et.changesNotSavedToDraft?"Save draft before publishing to live":null!==(e=Et.syncStatus.live)&&void 0!==e&&e.synced?"Updated on live site":"Update on live site"}})}}),U(Y,{get when(){return!Et.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},get loading(){return Et.publishing},onClick:e=>Et.publish(e),get disabled(){var e;return(null===(e=Et.syncStatus.live)||void 0===e?void 0:e.synced)||Et.changesNotSavedToDraft},get children(){var e;return Et.changesNotSavedToDraft?"Save to draft or discard unapproved changes to publish":null!==(e=Et.syncStatus.live)&&void 0!==e&&e.synced?"Updated on live site":"Update on live site"}})}})]}}),U(Y,{get when(){return"rejected"===Et.approvalStatus},get children(){return U(Y,{get when(){return!Et.options.userHasPublicationRights},get children(){return U(ht,{get leftMargin(){return Et.options.metaMenu},onClick:e=>null,disabled:!0,get children(){return Et.changesNotSavedToDraft?"Save draft before requesting publication approval":"Make changes before requesting approval to publish"}})}})}})],Wt=({options:e})=>{const[t,n]=De({}),[r,o]=g(!0),[i,l]=g(!1),[s,a]=g(!1),[c,d]=g(!1),[u,p]=g(!1),[h,v]=g(!1),[m,b]=g(!1),[w,x]=g(!1),[k,S]=g(!1),C={permalink:e.permalink};let j,M;const q=!e.metaMenu&&!e.optionsMeta;y((()=>{q&&e.requireApproval&&(console.log("Options",e),Tt({options:e,setChecking:o,syncStatus:t,publish:e=>$(e)}))})),f((()=>{var t,n;e.metaMenu?(M=document.querySelector("#save_menu_footer"),N()):null!==(t=wp)&&void 0!==t&&null!==(n=t.data)&&void 0!==n&&n.select&&(j=wp.data.select("core/editor"),wp.domReady(A))})),f((()=>{wp&&wp.hooks&&wp.hooks.addAction&&(E(),wp.hooks.addAction("dls.post-saved","dls",(()=>{var e,n,r;if(null!=t&&null!==(e=t.draft)&&void 0!==e&&e.exists||null===(n=j)||void 0===n||!n.isPublishingPost())null!=t&&null!==(r=t.draft)&&void 0!==r&&r.exists&&(A(),E());else{const{isSavingPost:e}=j;let t=0;const n=setInterval((()=>{(!e()||t>=50)&&(location.reload(),clearInterval(n))}),100)}})))})),f((()=>{let e;document.addEventListener("cerberusListenerEvent",(t=>{var n;null!=t&&null!==(n=t.detail)&&void 0!==n&&n.hasChange&&(e||(e=document.querySelector(".editor-post-publish-button"),e.addEventListener("click",(()=>{b(!1),e.setAttribute("disabled",!0)}))),e&&(b(!0),e.removeAttribute("disabled")))}))}));const A=()=>{let e;const t=wp.data.subscribe(_.debounce((()=>{e||(e=document.querySelector(".editor-post-publish-button"));const n=j.isEditedPostDirty(),r=j.hasNonPostEntityChanges(),o=m();r||n||o?(p(!0),e&&e.addEventListener("click",P),e&&e.removeAttribute("disabled"),t()):(p(!1),e&&e.removeEventListener("click",P),e&&e.setAttribute("disabled",!0))}),100))},P=()=>{""!==Et.approvalStatus&&q&&e.requireApproval&&Et.options.requireApproval&&Bt()},N=()=>{let e,t=!1;M.setAttribute("disabled",!0);let n=()=>{t||clearInterval(e)},r=()=>{t||(e=o())};const o=()=>setInterval((()=>{var o,i;null!==(o=window)&&void 0!==o&&null!==(i=o.wpNavMenu)&&void 0!==i&&i.menusChanged&&(t=!0,D(),clearInterval(e),window.removeEventListener("blur",n),window.removeEventListener("focus",r))}),500);e=o(),window.addEventListener("blur",n),window.addEventListener("focus",r)},D=()=>{M.removeAttribute("disabled"),v(!0)},E=async(r=!0)=>{r&&(o(!0),await new Promise((e=>setTimeout(e,1e3))));try{var i;const r=await We("check_sync",{...C,api_path:C.permalink});if(null==r||null===(i=r.data)||void 0===i||!i.resourceStatus)throw C;n({draft:r.data.resourceStatus.find((e=>"draft"===e.target&&"__original"===e.comparedTo)),live:r.data.resourceStatus.find((e=>"live"===e.target&&"draft"===e.comparedTo)),state:"loaded"}),console.log("status: ",t),S(!1),q&&e.requireApproval&&(async()=>{console.log("Getting publication request for:",Et.options.permalink);try{var e;const t=await Xe(`${Et.options.api}/get-publication-request.php`,{postId:Et.options.postId});if(null!==(e=t.data.resource)&&void 0!==e&&e.content){const e=t.data.resource.content;Tt({approvalStatus:e.status,approvedBy:e.approvedBy,rejectedBy:e.rejectedBy,rejectionReason:e.rejectionReason||"",requestedBy:e.requestedBy,editorEmail:e.from_user_email,postTitle:e.post_title,siteTitle:e.from_site_name}),console.log("Publication request: ",Et)}else console.log("No publication request found for:",Et.options.permalink),Rt("")}catch(e){console.log("Error fetching publication request",e)}})(),e.metaMenu&&T()}catch(e){console.log("--- meta-box --- Can't find any data with check-sync of payload: ",e),S(!0),o(!1),n({state:"error"})}o(!1)},T=async()=>{var e;const n=document.querySelectorAll(".menu-theme-locations > .menu-settings-input"),r=document.querySelector(".menu-settings-group.menu-theme-locations"),o=document.createElement("i");o.classList.add("changes-disabled-message");const i=null===(e=t.draft)||void 0===e?void 0:e.exists,l=t.live&&t.live.exists;!i||l?(r.style.pointerEvents="none",r.style.cursor="not-allowed",r.style.opacity=.5):(r.style.pointerEvents="auto",r.style.cursor="default",r.style.opacity=1);const s=document.querySelector(".changes-disabled-message");if(l){const e="Menu must be unpublished before toggling location";s?s.innerHTML=e:(o.innerHTML=e,r.prepend(o))}else{const e="Menu must be created before toggling location";i?s&&s.parentNode.removeChild(s):s?s.innerHTML=e:(o.innerHTML=e,r.prepend(o))}let a=!1,c=!1;for(let e of n){const t=e.querySelector("input");t.addEventListener("change",(()=>{d(!0),D()}));e.querySelector(".theme-location-set")&&(t.setAttribute("disabled",!0),e.style.pointerEvents="none",e.style.opacity=.5,c=!0),t.getAttribute("checked")&&(a=!0)}if(c&&!l&&i){const e=document.querySelector(".changes-disabled-message"),t="Some locations cannot be set because they are already set";e?e.innerHTML=t:(o.innerHTML=t,r.prepend(o))}if(location.search.includes("menu=0"))return;x(!0);const u=document.querySelector(".submitdelete.deletion.menu-delete");let p=document.querySelector(".delete-link-replacement");a||l?(u.style.display="none",p?p.style.display="inline":(p=document.createElement("span"),p.classList.add("delete-link-replacement"),p.innerHTML="To delete a menu it must be unpublished (and unregisterered from all display locations)",p.style.color="#a7aaad",p.style.fontSize="12px"),u.parentNode.prepend(p)):(u.style.display="inline",p&&(p.style.display="none"))},R=(e={})=>{if(document){const t=new CustomEvent("cerberusChangeEvent",{detail:e});document.dispatchEvent(t)}},$=async t=>{t.preventDefault(),t.stopPropagation(),l(!0);(await We("publish_to_live",C)).data?E(!1):n({state:"error"}),await new Promise((e=>setTimeout(e,1e3))),l(!1),q&&e.requireApproval&&""!==Et.approvalStatus&&Bt(),R({action:"publish_to_live_done"})},L=async e=>{e.preventDefault(),e.stopPropagation(),a(!0);(await We("unpublish_from_live",C)).data?E(!1):n({state:"error"}),await new Promise((e=>setTimeout(e,1e3))),a(!1),R({action:"unpublish_from_live_done"})};f((()=>{q&&Tt({changesNotSavedToDraft:z()})})),f((()=>{q&&Tt({publishing:i()})})),f((()=>{q&&Tt({publishing:i()})}));const z=()=>u()||h()||m();return U(At,{get horizontal(){return e.metaMenu},get box(){return e.optionsMeta},get children(){return[U(Y,{get when(){return r()},get children(){return U(_t,{get horizontal(){return e.metaMenu},get children(){return[U(ut,{get size(){return e.metaMenu?"small":"large"}}),U(Dt,{children:"Checking content in draft and live"})]}})}}),U(Y,{get when(){return!r()},get children(){return[U(Y,{get when(){return k()},get children(){return U(_t,{get horizontal(){return e.metaMenu},get children(){return U(Dt,{children:"Content must be saved before publishing"})}})}}),U(Y,{get when(){var e;return!c()&&(null===(e=t.draft)||void 0===e?void 0:e.exists)},get children(){return[U(Y,{get when(){return q&&e.requireApproval},get children(){return U(Ht,{})}}),U(Y,{get when(){return!e.requireApproval},get children(){return U(Dt,{get horizontal(){return e.metaMenu},children:"Publish content"})}}),U(Y,{get when(){var e;return!(null!==(e=t.live)&&void 0!==e&&e.exists)},get children(){return[ne((()=>q&&e.requireApproval?U(Yt,{}):U(ht,{get leftMargin(){return e.metaMenu},get loading(){return i()},onClick:e=>$(e),get disabled(){return z()},get children(){return z()?"Save draft before publishing to live":"Publish to live site"}}))),U(ht,{get leftMargin(){return e.metaMenu},disabled:!0,children:"Content not published"}),U(Y,{when:q,get children(){return U(Gt,{})}})]}}),U(Y,{get when(){var e;return null===(e=t.live)||void 0===e?void 0:e.exists},get children(){return[ne((()=>q&&!e.optionsMeta&&e.requireApproval?U(Vt,{}):U(ht,{get leftMargin(){return e.metaMenu},get loading(){return i()},onClick:e=>$(e),get disabled(){var e;return(null===(e=t.live)||void 0===e?void 0:e.synced)||z()},get children(){var e;return z()?"Save draft before updating on live":null!==(e=t.live)&&void 0!==e&&e.synced?"Updated on live site":"Update on live site"}}))),U(ht,{get leftMargin(){return e.metaMenu},get loading(){return s()},onClick:e=>L(e),get disabled(){return m()},children:"Unpublish"}),U(Y,{when:q,get children(){return U(Gt,{})}})]}})]}}),U(Y,{get when(){return e.metaMenu},get children(){return U(_t,{get horizontal(){return e.metaMenu},get children(){return[U(Y,{get when(){return!w()},get children(){return U(Dt,{children:"Enter a 'Menu Name' above to create a new menu"})}}),(()=>{const e=ne((()=>{var e;return!(c()||null!==(e=t.draft)&&void 0!==e&&e.exists)}),!0);return U(Y,{get when(){return e()&&w()},get children(){return U(Dt,{children:"Save menu with menu items in order to publish"})}})})(),U(Y,{get when(){return c()},get children(){return U(Dt,{children:"Save the changes before publishing"})}})]}})}})]}}),U(Y,{get when(){return e.enableTestContent},get children(){return U(ht,{get leftMargin(){return e.metaMenu},get loading(){return s()},onClick:e=>L(e),get disabled(){var e;return!(null!==(e=t.test)&&void 0!==e&&e.synced)},get children(){return t.test&&t.test.synced?"Unpublish from test target":"Publish to test target"}})}}),U(Y,{get when(){return Et.errorMessage},get children(){return U(Pt,{get children(){return Et.errorMessage}})}})]}})},Xt=Qe("input")`
`,Zt=Qe("div")`
    display: flex;
    flex-direction: column;
    width: 100%;
...
`,en=Qe("label")`
    ...
    font-size: 10px;
    height: 18px;
`,tn=({placeholder:e="",label:t=" ",value:n,onChange:r=(()=>{})})=>{const o=e=>{r(e.target.value)};return U(Zt,{get children(){return[U(en,{children:t}),U(Xt,{type:"text",get value(){return n()},placeholder:e,onKeyup:o})]}})},nn=Qe("select")`
...
`,In=Qe("p")`
    font-size: 15px;
`,Hn=({options:e})=>{const[t,n]=g([]),[r,o]=g([]),[i,l]=g([]),[s,a]=g(!1),[c,d]=g("");y((()=>{a(!0),u()}));const u=async()=>{try{var t;const n=await Xe(`${e.api}/get-publication-requests.php`);p(null==n||null===(t=n.data)||void 0===t?void 0:t.resources)}catch(e){console.log("Error fetching all publication requests",e),d("Error fetching all publication requests")}},p=(e=[])=>{const t={pending:{},approved:{},rejected:{}};console.log("Unsorted requests",e);e.sort(((e,t)=>new Date(t.content.updated_on)-new Date(e.content.updated_on))).forEach((e=>{const n=e.content.status,r=h(e.content["wp-domain"]),o=e.content.from_site_name+" - "+r;t[n][o]||(t[n][o]=[]),t[n][o].push(e)})),console.log("Approved: ",t.approved),console.log("Pending: ",t.pending),console.log("Rejected: ",t.rejected),n(t.approved),l(t.rejected),o(t.pending),a(!1)},h=e=>{const t=e.indexOf("://");return e.slice(t+3)},f=({title:t,siteRequests:n})=>{const r=Object.keys(n);return U(Bn,{get children(){return[U(st,{children:t}),U(Y,{get when(){return 0!==r.length},get fallback(){return U(Nn,{children:"None to show"})},get children(){return U(Q,{each:r,children:t=>U(On,{get children(){return[U(In,{children:t}),U(Q,{get each(){return n[t]},children:t=>U(Rn,{item:t,manualDelete:()=>(async t=>{console.log("Deleting publication request: "+t);try{var n;const o=await Xe(`${e.api}/delete-publication-request.php`,{postId:t});var r;if(console.log("Delete result",o),null!=o&&null!==(n=o.errors)&&void 0!==n&&n.length)throw new Error(null===(r=o.errors[0])||void 0===r?void 0:r.message);u()}catch(e){console.log("Error deleting publication request",e),d("Error deleting publication request")}})(t.content.post_id),type:"admin"})})]}})})}})]}})};return(()=>{const e=zn.cloneNode(!0);return ge(e,U(it,{children:"All Publication requests"}),null),ge(e,(()=>{const e=ne((()=>!!s()),!0);return U(Y,{get when(){return e()&&!c()},get children(){return U(Nn,{children:"Loading..."})}})})(),null),ge(e,(()=>{const e=ne((()=>!s()),!0);return U(Y,{get when(){return e()&&!c()},get children(){return[ne((()=>f({title:"Pending",siteRequests:r()}))),ne((()=>f({title:"Approved",siteRequests:t()}))),ne((()=>f({title:"Rejected",siteRequests:i()})))]}})})(),null),ge(e,U(Y,{get when(){return c()},get children(){return[(()=>{const e=$n.cloneNode(!0);return ge(e,c),e})(),Ln.cloneNode(!0)]}}),null),e})()},Un=le("<p></p>"),Fn=le("<p>Reload page</p>"),Kn=le("<div></div>"),Jn=Qe("div")`
    margin-bottom: 3rem;
`,Qn=Qe("div")`
    margin-top: 1rem;
    margin-bottom: 2rem;
`,Yn=Qe("p")`
    font-size: 15px;
`,Gn=({options:e})=>{const[t,n]=g([]),[r,o]=g([]),[i,l]=g([]),[s,a]=g(!1),[c,d]=g("");y((()=>{a(!0),u()}));const u=async()=>{try{var t;const n=await Xe(`${e.api}/get-publication-requests.php`);p(null==n||null===(t=n.data)||void 0===t?void 0:t.resources)}catch(e){console.log("Error fetching all publication requests",e),d("Error fetching all publication requests")}},p=(t=[])=>{const r={pending:{},approved:{},rejected:{}};console.log("Unsorted requests",t);t.filter((t=>t.content.requestedBy===e.userName)).sort(((e,t)=>new Date(t.content.updated_on)-new Date(e.content.updated_on))).forEach((e=>{const t=e.content.status,n=h(e.content["wp-domain"]),o=e.content.from_site_name+" - "+n;r[t][o]||(r[t][o]=[]),r[t][o].push(e)})),console.log("Approved: ",r.approved),console.log("Pending: ",r.pending),console.log("Rejected: ",r.rejected),n(r.approved),l(r.rejected),o(r.pending),a(!1)},h=e=>{const t=e.indexOf("://");return e.slice(t+3)},f=({title:t,siteRequests:n})=>{const r=Object.keys(n);return U(Jn,{get children(){return[U(st,{children:t}),U(Y,{get when(){return 0!==r.length},get fallback(){return U(Nn,{children:"None to show"})},get children(){return U(Q,{each:r,children:t=>U(Qn,{get children(){return[U(Yn,{children:t}),U(Q,{get each(){return n[t]},children:t=>U(Rn,{item:t,manualDelete:()=>(async t=>{console.log("Deleting publication request: "+t);try{var n;const o=await Xe(`${e.api}/delete-publication-request.php`,{postId:t});var r;if(console.log("Delete result",o),null!=o&&null!==(n=o.errors)&&void 0!==n&&n.length)throw new Error(null===(r=o.errors[0])||void 0===r?void 0:r.message);u()}catch(e){console.log("Error deleting publication request",e),d("Error deleting publication request")}})(t.content.post_id),type:"editor"})})]}})})}})]}})};return(()=>{const e=Kn.cloneNode(!0);return ge(e,U(it,{children:"Personal publication requests"}),null),ge(e,(()=>{const e=ne((()=>!!s()),!0);return U(Y,{get when(){return e()&&!c()},get children(){return U(Nn,{children:"Loading..."})}})})(),null),ge(e,(()=>{const e=ne((()=>!s()),!0);return U(Y,{get when(){return e()&&!c()},get children(){return[ne((()=>f({title:"Pending",siteRequests:r()}))),ne((()=>f({title:"Approved",siteRequests:t()}))),ne((()=>f({title:"Rejected",siteRequests:i()})))]}})})(),null),ge(e,U(Y,{get when(){return c()},get children(){return[(()=>{const e=Un.cloneNode(!0);return ge(e,c),e})(),Fn.cloneNode(!0)]}}),null),e})()},Vn=e=>{try{return JSON.parse(document.getElementById(e).innerHTML)}catch(e){return console.log("Error in getData",e),{}}},Wn=()=>{let e=document.getElementById("dls-metabox-root");if(e){const t=Vn("dls-data");t.metaMenu="nav-menu"===e.getAttribute("data-type"),t.metaMenu&&(e=document.createElement("div"),e&&document.querySelector("#nav-menu-footer").prepend(e)),ie((()=>U(Wt,{options:t})),e)}};jQuery(document).ready((function(e){var t,n;const r=null===(t=wp)||void 0===t||null===(n=t.data)||void 0===n?void 0:n.dispatch("core/editor");r&&r.disablePublishSidebar(),(()=>{if(wp.data){let e=!1,t=!1;wp.data.subscribe((()=>{const n=wp.data.select("core/editor").isSavingPost(),r=wp.data.select("core/editor").isSavingNonPostEntityChanges&&wp.data.select("core/editor").isSavingNonPostEntityChanges();e!==n?(e=n,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved")):t!==r&&(t=r,wp.data.select("core/editor").didPostSaveRequestSucceed()&&wp.hooks.doAction("dls.post-saved"))}))}})();let o={};try{o=e("#dls-hooks").length>0?JSON.parse(e("#dls-hooks").html()):{hook:""}}catch(e){}console.log("Current hook",o&&o.hook),"post.php"===o.hook||"post-new.php"===o.hook||"nav-menus.php"===o.hook?Wn():o.hook.includes("toplevel_page_draft-live-sync")?(()=>{const e=Vn("dls-data");ie((()=>U(Te,{values:e,get children(){return U(qt,{})}})),document.getElementById("dls-root"))})():o.hook.includes("toplevel_page_cerberus-domain-settings")?(()=>{const e=document.getElementById("dls-domain-settings-root"),t=Vn("dls-data");ie((()=>U(Sn,{options:t})),e)})():o.hook.includes("toplevel_page_publication-approval")?(()=>{const e=document.getElementById("dls-publication-approval-root"),t=Vn("dls-data");ie((()=>U(Hn,{options:t})),e)})():o.hook.includes("toplevel_page_publication-requests")?(()=>{const e=document.getElementById("dls-publication-requests-root"),t=Vn("dls-data");ie((()=>U(Gn,{options:t})),e)})():o.hook.includes(".php")||Wn()}))}();
//# sourceMappingURL=draft-live-sync-boot-0.16.10-atos.js.map
