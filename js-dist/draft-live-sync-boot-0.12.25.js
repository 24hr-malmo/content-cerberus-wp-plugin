...
`,yt=re('<svg height="10" width="10"><circle cx="5" cy="5" r="5" stroke-width="0"></circle></svg>'),bt=({showCheckButton:e,showSyncButton:t,showDraft:n,showLive:r,item:o,onClick:i,onTypeClick:l})=>{const s=(e,t)=>{let n="#bbbbbb";return"error"===t?n="#da694b":""===t?n="#bbbbbb":e&&(n=e.synced?"#99da4b":"#e9da4e"),n};return F(pt,{get children(){return[F(Q,{when:n,get children(){return F(mt,{get color(){var e,t;return s(null===(e=o.status)||void 0===e?void 0:e.draft,null===(t=o.status)||void 0===t?void 0:t.state)},get children(){return yt.cloneNode(!0)}})}}),F(Q,{when:r,get children(){return F(mt,{get color(){var e,t;return s(null===(e=o.status)||void 0===e?void 0:e.live,null===(t=o.status)||void 0===t?void 0:t.state)},get children(){return yt.cloneNode(!0)}})}}),F(Q,{when:t,get children(){return F(ft,{onClick:i,children:"sync"})}}),F(Q,{when:e,get children(){return F(ft,{onClick:i,children:"check"})}}),F(ht,{onClick:()=>l(o.type),get children(){return o.type}}),F(gt,{target:"_new",get href(){return o.permalink},get children(){return o.permalink||"/"}})]}})},vt=({type:e})=>{const[t,{apiUrl:n}]=x(Te),[r,o]=Pe({list:[]}),[i,l]=h(!1);g((async()=>{const e=(await Ve("get_all_resources")).list.map(((e,t)=>({...e,index:t})));o({list:e})}));const s=async t=>{try{(await Xe(`${n}/sync.php`,{action:"sync",permalink:t.permalink,release:e,sync_check:!1})).data?o("list",t.index,"status",{[e]:{synced:!0},state:"loaded"}):o("list",t.index,"status",{state:"error"})}catch(e){o("list",t.index,"status",{state:"error"})}},a="draft"===e?"Begin to sync to Draft":"Publish everything to Live",c="draft"===e?"Sync Draft":"Sync Live",d="draft"===e?"This is where you can make sure that wordpress and the draft content is in sync":"This is where you can make sure that Draft and Live are in sync";return F(Ge,{get children(){return[F(it,{title:c,description:d,get actions(){return F(ut,{get loading(){return i()},onClick:()=>(async()=>{if(i())return;let t=!1;if(("live"===e&&confirm("Do you really which to publish everything?")||"draft"===e)&&(t=!0),t){l(!0),r.list.forEach(((e,t)=>{o("list",t,"status",{state:""}),t++}));for await(let e of r.list)await s(e);l(!1)}})(),children:a})}}),F(J,{get each(){return r.list},children:t=>F(bt,{showDraft:"draft"===e,showLive:"live"===e,showSyncButton:!0,onClick:()=>(async e=>{l(!0),await s(e),l(!1)})(t),onTypeClick:()=>(async e=>{l(!0);const t=r.list.filter((t=>t.type===e));t.forEach(((e,t)=>{o("list",t,"status",{state:""}),t++}));for await(let e of t)await s(e);l(!1)})(t.type),item:t,get permalink(){return t.permalink}})})]}})},wt=()=>{const[e,{apiUrl:t}]=x(Te),[n,r]=Pe({list:[]}),[o,i]=h(!1);console.log(t),g((async()=>{const e=(await Ve("get_all_resources")).list.map(((e,t)=>({...e,index:t})));r({list:e})}));const l=async e=>{try{const n=await Xe(`${t}/check-sync.php`,{permalink:e.permalink});r("list",e.index,"status",{draft:n.data.resourceStatus.find((e=>"draft"===e.target&&"__original"===e.comparedTo)),live:n.data.resourceStatus.find((e=>"live"===e.target&&"draft"===e.comparedTo)),state:"loaded"})}catch(t){r("list",e.index,"status",{state:"error"})}};return F(Ge,{get children(){return[F(it,{title:"Sync Check",description:"This is where you can check if all content is in sync",get actions(){return F(ut,{get loading(){return o()},onClick:()=>(async()=>{if(!o()){i(!0),n.list.forEach(((e,t)=>{r("list",t,"status",{state:""}),t++}));for await(let e of n.list)await l(e);i(!1)}})(),children:"Begin to check"})}}),F(J,{get each(){return n.list},children:e=>F(bt,{showDraft:!0,showLive:!0,showCheckButton:!0,item:e,get permalink(){return e.permalink},onClick:()=>(async e=>{i(!0),await l(e),i(!1)})(e),onTypeClick:()=>(async e=>{i(!0);const t=n.list.filter((t=>t.type===e));t.forEach(((e,t)=>{r("list",t,"status",{state:""}),t++}));for await(let e of t)await l(e);i(!1)})(e.type)})})]}})},xt=Re("p")`
    ...
    padding: 1rem 2rem;
    text-align: center;
`,kt=()=>F(Ge,{get children(){return[F(it,{title:"Start",description:"This plugin lets you control and debug content through the content service."}),F(xt,{children:"This is mainly used while developing or by admins!"})]}}),St=Re("div")`
     color: black;
     max-width: 1200px;
     margin: 0 auto;
`;Re("div")`
...
`,_t=({options:e})=>{const[t,n]=Pe({}),[r,o]=h(!0),[i,l]=h(!1),[s,a]=h(!1),[c,d]=h(!1),[u,p]=h(!1),[f,m]=h(!1),[y,b]=h(!1),[v,w]=h(!1),x={permalink:e.permalink},k=wp.data.select("core/editor");g((()=>{wp&&wp.hooks&&wp.hooks.addAction&&(A(),wp.hooks.addAction("dls.post-saved","dls",(()=>{if(x.permalink.includes("/?")&&x.permalink.includes("_id=")){const{isSavingPost:e}=k;let t=0;const n=setInterval((()=>{(!e()||t>=50)&&(location.reload(),clearInterval(n))}),100)}else A()})))})),g((()=>{e.metaMenu?C():wp&&wp.domReady(S)}));const S=()=>{let e;wp.data.subscribe(_.debounce((()=>{e||(e=document.querySelector(".editor-post-publish-button"));const t=k.isEditedPostDirty();k.hasNonPostEntityChanges()||t?(p(!0),e.removeAttribute("disabled")):(p(!1),e.setAttribute("disabled",!0))}),300))},C=()=>{let e,t=!1;const n=document.querySelector("#save_menu_footer");n.setAttribute("disabled",!0);let r=()=>{t||clearInterval(e)},o=()=>{t||(e=i())};const i=()=>setInterval((()=>{var i,l;null!==(i=window)&&void 0!==i&&null!==(l=i.wpNavMenu)&&void 0!==l&&l.menusChanged&&(t=!0,n.removeAttribute("disabled"),m(!0),clearInterval(e),window.removeEventListener("blur",r),window.removeEventListener("focus",o))}),500);e=i(),window.addEventListener("blur",r),window.addEventListener("focus",o)},A=async(t=!0)=>{t&&(o(!0),await new Promise((e=>setTimeout(e,1e3))));try{var r;const t=await Xe(`${e.api}/check-sync.php`,x);if(null==t||null===(r=t.data)||void 0===r||!r.resourceStatus)throw x;n({draft:t.data.resourceStatus.find((e=>"draft"===e.target&&"__original"===e.comparedTo)),live:t.data.resourceStatus.find((e=>"live"===e.target&&"draft"===e.comparedTo)),state:"loaded"}),w(!1),e.metaMenu&&M()}catch(e){console.log("--- meta-box --- Can't find any data with check-sync of payload: ",e),w(!0),o(!1),n({state:"error"})}o(!1)},M=async()=>{var e;const n=document.querySelectorAll(".menu-theme-locations > .menu-settings-input"),r=document.querySelector(".submitdelete.deletion.menu-delete"),o=document.querySelector(".menu-settings-group.menu-theme-locations"),i=document.createElement("i");i.classList.add("changes-disabled-message");const l=null===(e=t.draft)||void 0===e?void 0:e.exists,s=t.live&&t.live.exists;!l||s?(o.style.pointerEvents="none",o.style.cursor="not-allowed",o.style.opacity=.5):(o.style.pointerEvents="auto",o.style.cursor="default",o.style.opacity=1);const a=document.querySelector(".changes-disabled-message");if(s){const e="Menu must be unpublished before toggling location";a?a.innerHTML=e:(i.innerHTML=e,o.prepend(i))}else{const e="Menu must be saved to draft before toggling location";l?a&&a.parentNode.removeChild(a):a?a.innerHTML=e:(i.innerHTML=e,o.prepend(i))}let c=!1,u=!1;for(let e of n){const t=e.querySelector("input");t.addEventListener("change",(()=>d(!0)));e.querySelector(".theme-location-set")&&(t.setAttribute("disabled",!0),e.style.pointerEvents="none",e.style.opacity=.5,u=!0),t.getAttribute("checked")&&(c=!0)}if(u&&!s){const e=document.querySelector(".changes-disabled-message"),t="Some locations cannot be set until they have been unset from their original menu";e?e.innerHTML=t:(i.innerHTML=t,o.prepend(i))}if(!r)return;b(!0);let p=document.querySelector(".delete-link-replacement");c||s?(r.style.display="none",p?p.style.display="inline":(p=document.createElement("span"),p.classList.add("delete-link-replacement"),p.innerHTML="To delete a menu it must be unpublished (and unregisterered from all display locations)",p.style.color="#a7aaad",p.style.fontSize="12px"),r.parentNode.prepend(p)):(r.style.display="inline",p&&(p.style.display="none"))},j=async e=>{e.preventDefault(),e.stopPropagation(),l(!0);(await Ve("publish_to_live",x)).data?A(!1):n({state:"error"}),await new Promise((e=>setTimeout(e,1e3))),l(!1)},P=async e=>{e.preventDefault(),e.stopPropagation(),a(!0);(await Ve("unpublish_from_live",x)).data?A(!1):n({state:"error"}),await new Promise((e=>setTimeout(e,1e3))),a(!1)};return F(At,{get horizontal(){return e.metaMenu},get box(){return e.optionsMeta},get children(){return[F(Q,{get when(){return r()},get children(){return F(Mt,{get horizontal(){return e.metaMenu},get children(){return[F(at,{get size(){return e.metaMenu?"small":"large"}}),F(jt,{children:"Checking content in draft and live"})]}})}}),F(Q,{get when(){return!r()},get children(){return[F(Q,{get when(){return v()},get children(){return F(Mt,{get horizontal(){return e.metaMenu},get children(){return F(jt,{children:"Content must be saved before publishing"})}})}}),F(Q,{get when(){var e;return!c()&&(null===(e=t.draft)||void 0===e?void 0:e.exists)},get children(){return[F(jt,{get horizontal(){return e.metaMenu},children:"Publish content"}),F(Q,{get when(){var e;return!(null!==(e=t.live)&&void 0!==e&&e.exists)},get children(){return[F(ut,{get leftMargin(){return e.metaMenu},get loading(){return i()},onClick:e=>j(e),get disabled(){return u()||f()},get children(){return u()||f()?"Save draft before publishing to live":"Publish to live site"}}),F(ut,{get leftMargin(){return e.metaMenu},get disabled(){var e;return!(null!==(e=t.live)&&void 0!==e&&e.synced)},children:"Content not published"})]}}),F(Q,{get when(){var e;return null===(e=t.live)||void 0===e?void 0:e.exists},get children(){return[F(Q,{get when(){var e;return null===(e=t.live)||void 0===e?void 0:e.synced},get children(){return F(ut,{get leftMargin(){return e.metaMenu},get loading(){return i()},disabled:!0,get children(){return u()||f()?"Save draft before updating on live":"Updated on live site"}})}}),F(Q,{get when(){var e;return!(null!==(e=t.live)&&void 0!==e&&e.synced)},get children(){return F(ut,{get leftMargin(){return e.metaMenu},get loading(){return i()},onClick:e=>j(e),get children(){return u()||f()?"Save draft before updating on live":"Update on live site"}})}}),F(ut,{get leftMargin(){return e.metaMenu},get loading(){return s()},onClick:e=>P(e),children:"Unpublish"})]}})]}}),F(Q,{get when(){return e.metaMenu},get children(){return F(Mt,{get horizontal(){return e.metaMenu},get children(){return[F(Q,{get when(){return!y()},get children(){return F(jt,{children:"Enter a 'Menu Name' above to create a new menu"})}}),(()=>{const e=W((()=>{var e;return!(c()||null!==(e=t.draft)&&void 0!==e&&e.exists)}),!0);return F(Q,{get when(){return e()&&y()},get children(){return F(jt,{children:"Save menu with menu items in order to publish"})}})})(),F(Q,{get when(){return c()},get children(){return F(jt,{children:"Save the changes before publishing"})}})]}})}})]}}),F(Q,{get when(){return e.enableTestContent},get children(){return F(ut,{get leftMargin(){return e.metaMenu},get loading(){return s()},onClick:e=>P(e),get disabled(){var e;return!(null!==(e=t.test)&&void 0!==e&&e.synced)},get children(){return t.test&&t.test.synced?"Unpublish from test target":"Publish to test target"}})}}),F(Q,{get when(){return e.enableDiffButton},get children(){return F(ut,{get leftMargin(){return e.metaMenu},children:"Show diff (raw)"})}})]}})},Pt=Re("input")`
`,Tt=Re("div")`
    display: flex;
    flex-direction: column;
    width: 100%;
