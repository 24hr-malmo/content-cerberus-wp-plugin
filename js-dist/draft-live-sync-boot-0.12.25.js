...
`;
  ...
  const MetaBox = ({
    ...
    const coreEditor = wp.data.select('core/editor'); // Dont run this if its an older version of wp or not running gutenberg
    ...
    const menuCheck = async () => {
      ...
      const savedToDraft = (_status$draft = status.draft) === null || _status$draft === void 0 ? void 0 : _status$draft.exists;
          ...
          get children() {
            return [createComponent(Show, {
              ...
              get when() {
                ...
                return !unsavedMenuDisplayLocations() && ((_status$draft2 = status.draft) === null || _status$draft2 === void 0 ? void 0 : _status$draft2.exists);
              },
                  ...
                  get children() {
                    return [createComponent(Show, {
                      get when() {
                        ...
                        return (_status$live4 = status.live) === null || _status$live4 === void 0 ? void 0 : _status$live4.synced;
                      },
                      ...
                      get children() {
                        return createComponent(Button, {
                          ...
                          get children() {
                            return unsavedPageChanges() || unsavedMenuChanges() ? 'Save draft before updating on live' : 'Updated on live site';
                          }
                      ...
                      get when() {
                        ...
                        return !((_status$live5 = status.live) !== null && _status$live5 !== void 0 && _status$live5.synced);
                      },
                      ...
                      get children() {
                        return createComponent(Button, {
                          ...
                          get children() {
                            return unsavedPageChanges() || unsavedMenuChanges() ? 'Save draft before updating on live' : 'Update on live site';
                          }
                  ...
                  get children() {
                    return [createComponent(Show, {
                      ...
                      const _c$ = memo(() => {
                        ...
                        return !!(!unsavedMenuDisplayLocations() && !((_status$draft3 = status.draft) !== null && _status$draft3 !== void 0 && _status$draft3.exists));
                      }, true);
