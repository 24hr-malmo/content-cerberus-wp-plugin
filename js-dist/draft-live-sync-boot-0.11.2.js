...
`,Nt=Ue("label")`
    ...
    font-size: 10px;
    height: 18px;
`,zt=te("<option></option>"),Mt=({options:e=[],placeholder:t="",label:n=" ",value:r,onChange:o=(()=>{})})=>{const[i,l]=p(!1),s=e=>{console.log(e),o(e.target.value),l(!0)};return I(Ot,{get children(){return[I(Nt,{children:n}),I(Tt,{get value(){return r()},placeholder:t,onChange:s,get children(){return I(R,{each:e,children:e=>(()=>{const t=zt.cloneNode(!0);return ae(t,(()=>e.label)),f((n=>{const o=e.value,l=e.value===r()&&!i();return o!==n._v$&&(t.value=n._v$=o),l!==n._v$2&&(t.selected=n._v$2=l),n}),{_v$:void 0,_v$2:void 0}),t})()})}})]}})},Lt={open:Fe`
    0% {
        max-height: 0;
    }
    100% {
...
//# sourceMappingURL=draft-live-sync-boot-0.11.2.js.map
