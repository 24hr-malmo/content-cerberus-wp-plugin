...
`;
  ...
  const MetaBox = ({
    ...
    createEffect(() => {
      if (wp && wp.hooks && wp.hooks.addAction) {
        ...
        wp.hooks.addAction('dls.post-saved', 'dls', () => {
          ...
          if (!(status !== null && status !== void 0 && (_status$draft = status.draft) !== null && _status$draft !== void 0 && _status$draft.exists)) {
            /**
    ...
    const menuCheck = async () => {
      ...
      const existsInDraft = (_status$draft2 = status.draft) === null || _status$draft2 === void 0 ? void 0 : _status$draft2.exists;
          ...
          get children() {
            return [createComponent(Show, {
              ...
              get when() {
                ...
                return !unsavedMenuDisplayLocations() && ((_status$draft3 = status.draft) === null || _status$draft3 === void 0 ? void 0 : _status$draft3.exists);
              },
                  ...
                  get children() {
                    return [createComponent(Show, {
                      ...
                      const _c$ = memo(() => {
                        ...
                        return !!(!unsavedMenuDisplayLocations() && !((_status$draft4 = status.draft) !== null && _status$draft4 !== void 0 && _status$draft4.exists));
                      }, true);
