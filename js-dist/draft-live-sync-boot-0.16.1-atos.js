...
`,Rn=e=>K(Dn,{get key(){return e.item.post_id},get children(){return[K(_n,{get children(){return e.item.type}}),K(Tn,{get children(){return[K(Nn,{get href(){return e.item.editorUrl},target:"_blank",get children(){return e.item.post_title}}),(()=>{const t=jn.cloneNode(!0);return fe(t.firstChild.nextSibling,(()=>e.item.from_user_name)),t})(),K(W,{get when(){return"rejected"===e.item.status},get children(){const t=An.cloneNode(!0),n=t.firstChild.nextSibling;n.nextSibling;return fe(t,(()=>e.item.rejectedBy),n),t}}),"(",oe((()=>(()=>{const t=new Date(e.item.updated_on);return t.getFullYear()+"-"+(t.getMonth()+1).toString().padStart(2,"0")+"-"+t.getDate().toString().padStart(2,"0")+", "+t.getHours().toString().padStart(2,"0")+":"+t.getMinutes().toString().padStart(2,"0")})())),")",K(W,{get when(){return"rejected"===e.item.status},get children(){return K(En,{get children(){return[K(qn,{children:"Rejection message:"}),(()=>{const t=Pn.cloneNode(!0);return fe(t,(()=>e.item.rejectionReason)),t})()]}})}})]}})]}}),Ln=se("<span></span>"),$n=se("<div></div>"),zn=Ve("div")`
    margin-bottom: 3rem;
`,On=Ve("div")`
    margin-top: 1rem;
    margin-bottom: 2rem;
